...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vo(e,t,n){let r=new Float32Array(Do),i=new J(0,1,0);return new ra({name:`SphericalGaussianBlur`,defines:{n:Do,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Wo(),fragmentShader:`
...
`)}async update(e){let t=e.clientWidth||e.offsetWidth,n=e.clientHeight||e.offsetHeight;if(t===0||n===0){let t=this.entries.get(e);return t?t.canvas:this.ensureEntry(e,1,1).canvas}let r=this.ensureEntry(e,t,n),i=Math.max(1,this.pixelRatio),a=r.canvas.width,o=r.canvas.height,s=await this.buildSvg(e,t,n,i);if(s===r.lastSvg)return Wl&&console.log(`[html-in-canvas debug] rasterization skipped (unchanged)`),r.canvas;if(Wl&&r.lastSvg){let e=r.lastSvg.split(`<`),t=s.split(`<`),n=[],i=Math.max(e.length,t.length);for(let r=0;r<i;r++)if(e[r]!==t[r]&&(n.push(`  - ${(e[r]||``).slice(0,120)}`),n.push(`  + ${(t[r]||``).slice(0,120)}`)),n.length>20){n.push(`  ...`);break}console.log(`[html-in-canvas debug] SVG changed:
`+n.join(`
`))}r.lastSvg=s;let c=await Jl(s,a,o);return r.context.clearRect(0,0,a,o),r.context.drawImage(c,0,0,a,o),r.canvas}getCanvas(e){return this.entries.get(e)?.canvas??null}getCssSize(e){let t=this.entries.get(e);return t?{width:t.cssW,height:t.cssH}:null}setPageStyles(e){this.pageStyles=e}async getPageStylesCss(){if(!this.pageStylesCssPromise){let e=Yl();this.pageStylesCssPromise=e,e.catch(()=>{this.pageStylesCssPromise===e&&(this.pageStylesCssPromise=null)})}return this.pageStylesCssPromise}invalidatePageStylesCss(){this.pageStylesCssPromise=null}cleanup(){this.entries.clear(),this.pageStylesCssPromise=null,lu.clear(),iu&&=(iu.remove(),null)}captureDynamicStateOnClone(e,t){let n=[e,...e.querySelectorAll(`*`)],r=[t,...t.querySelectorAll(`*`)];if(n.length===r.length){for(let e=0;e<n.length;e++)nu(n[e],r[e]);ou(e,t),su(e,t)}}ensureEntry(e,t,n){let r=Math.max(1,this.pixelRatio),i=Math.max(1,Math.ceil(t*r)),a=Math.max(1,Math.ceil(n*r)),o=this.entries.get(e);if(o)(o.canvas.width!==i||o.canvas.height!==a)&&(o.canvas.width=i,o.canvas.height=a),o.cssW=t,o.cssH=n;else{let r=document.createElement(`canvas`);r.width=i,r.height=a,o={canvas:r,context:r.getContext(`2d`),cssW:t,cssH:n},this.entries.set(e,o)}return o}async buildSvg(e,t,n,r=1){let i=await Kl(e);this.captureDynamicStateOnClone(e,i);let a=ql(e,new XMLSerializer().serializeToString(i)),o=await this.getPageStylesCss(),s=`<svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${n}" viewBox="0 0 ${t} ${n}"><style><![CDATA[${(Xl+`
`+o+`
`+this.pageStyles+`
`+this.svgOnlyStyles).replace(/]]>/g,`]]]]><![CDATA[>`)}]]></style><foreignObject x="0" y="0" width="100%" height="100%">${a}</foreignObject></svg>`;if(Wl){let e=document.getElementById(`__hic-svg-debug__`);e||(e=document.createElement(`div`),e.id=`__hic-svg-debug__`,e.style.cssText=`position:absolute;z-index:99999;pointer-events:none;opacity:0.3;box-sizing:border-box;margin:0;padding:0;border:none;overflow:hidden;`,document.body.appendChild(e));let t=document.querySelector(`canvas`);if(t){let n=t.getBoundingClientRect();e.style.left=n.left+window.scrollX+`px`,e.style.top=n.top+window.scrollY+`px`,e.style.width=n.width+`px`,e.style.height=n.height+`px`}if(!e.innerHTML){e.innerHTML=s;let t=e.querySelector(`svg`);t&&(t.style.width=`100%`,t.style.height=`100%`)}}return s}};async function Kl(e){let t=e.cloneNode(!0);return Ul(e,t),cu(e,t),t.style.removeProperty(`transform`),t.style.opacity=`1`,t.style.visibility=`visible`,await du(t),t.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),t}function ql(e,t){let n=e.parentElement,r=n?.getAttribute(`class`)||``,i=n?.clientWidth||e.clientWidth||e.offsetWidth,a=n?.clientHeight||e.clientHeight||e.offsetHeight;return`<html xmlns="http://www.w3.org/1999/xhtml" style="margin:0;padding:0;background:transparent !important;"><body style="margin:0;padding:0;background:transparent !important;"><div xmlns="http://www.w3.org/1999/xhtml"${r?` class="${tu(r)}"`:``} style="position:relative;width:${i}px;height:${a}px;margin:0;padding:0;">`+t+`</div></body></html>`}async function Jl(e,t,n){let r=`data:image/svg+xml;charset=UTF-8,`+encodeURIComponent(e);try{return await Rl(r)}catch(r){let i=r&&typeof r==`object`&&`type`in r?r.type:typeof r,a=Error(`HtmlRenderer: SVG image failed to load (${i}). cssW=${t}, cssH=${n}, svg.length=${e.length}. svg head: ${e.slice(0,300).replace(/\s+/g,` `)}…`);throw a.cause=r,a.svg=e,a}}async function Yl(){let e=[];for(let t of Array.from(document.styleSheets))try{let n=Array.from(t.cssRules||[]);e.push(n.map(e=>e.cssText).join(`
`))}catch{if(!t.href)continue;try{let n=await fetch(t.href);n.ok&&e.push(await n.text())}catch(e){console.warn(`[HtmlRenderer] failed to fetch stylesheet`,t.href,e)}}if(e.length===0)return``;let t;try{t=await Hl(e.join(`
`),async e=>{if(e.startsWith(`http://www.w3.org/`))return e;try{return await uu(e)}catch{return e}})}catch(n){console.warn(`[HtmlRenderer] URL embedding failed`,n),t=e.join(`
`)}let n=$l(t);return n?t+`
`+n:t}var Xl=`
...
`,Zl=/:(?:hover|focus-visible|focus-within|focus(?!-)|active)\b/g,Ql=/:(?:hover|focus-visible|focus-within|focus(?!-)|active)\b/;function $l(e){let t;try{t=new CSSStyleSheet,t.replaceSync(e)}catch{return``}let n=[];return eu(t.cssRules,n),n.join(`
`)}function eu(e,t){for(let n=0;n<e.length;n++){let r=e[n];if(r instanceof CSSStyleRule){if(Ql.test(r.selectorText)){let e=r.selectorText.replace(Zl,e=>`.pseudo-`+e.slice(1));t.push(`${e} { ${r.style.cssText} }`)}}else if(`cssRules`in r){let e=r,n=[];if(eu(e.cssRules,n),n.length){let e=``;e=r instanceof CSSMediaRule?`@media ${r.conditionText}`:r instanceof CSSSupportsRule?`@supports ${r.conditionText}`:(r.cssText?.split(`{`)[0])?.trim()??``,e&&t.push(`${e} {
${n.join(`
`)}
}`)}}}}function tu(e){return e.replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function nu(e,t){(e.scrollLeft!==0||e.scrollTop!==0)&&(t.style.setProperty(`--scroll-left`,-e.scrollLeft+`px`),t.style.setProperty(`--scroll-top`,-e.scrollTop+`px`));let n=e.getAnimations();if(n.length!==1)return;let r=n[0],i=typeof r.currentTime==`number`?r.currentTime:0,a=getComputedStyle(e).animationDelay,o=((a.endsWith(`ms`)?parseFloat(a)/1e3:parseFloat(a))||0)-i/1e3;t.style.setProperty(`--animation-delay`,o+`s`)}var ru=`fontFamily.fontSize.fontWeight.fontStyle.fontVariant.lineHeight.letterSpacing.wordSpacing.textIndent.textTransform.whiteSpace.wordWrap.overflowWrap.wordBreak.paddingTop.paddingRight.paddingBottom.paddingLeft.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.boxSizing.width.direction.textAlign`.split(`.`),iu=null;function au(e,t){iu||(iu=document.createElement(`div`),iu.style.cssText=`position:absolute;left:-9999px;top:-9999px;visibility:hidden;overflow:hidden;`,document.body.appendChild(iu));let n=getComputedStyle(e),r=e instanceof HTMLInputElement;for(let e of ru)iu.style[e]=n[e];iu.style.whiteSpace=r?`pre`:n.whiteSpace,iu.style.height=`auto`,iu.style.overflowY=`hidden`;let i=e.value,a=i.substring(0,t);iu.textContent=``;let o=document.createTextNode(a),s=document.createElement(`span`);s.textContent=`|`,iu.appendChild(o),iu.appendChild(s),iu.appendChild(document.createTextNode(i.substring(t)||`.`));let c=parseFloat(n.fontSize),l=parseFloat(n.lineHeight),u=isNaN(l)?c*1.2:n.lineHeight.endsWith(`px`)?l:l*c;return{x:s.offsetLeft,y:s.offsetTop,height:u}}function ou(e,t){let n=document.activeElement;if(!n)return;let r;if(n instanceof HTMLInputElement){let e=n.type;if(e!==`text`&&e!==`search`&&e!==`url`&&e!==`tel`&&e!==`password`&&e!==``)return;r=n}else if(n instanceof HTMLTextAreaElement)r=n;else return;if(!e.contains(r))return;let i=r.selectionStart,a=r.selectionEnd;if(i===null||a===null)return;let o=getComputedStyle(r),s=parseFloat(o.borderLeftWidth)||0,c=parseFloat(o.borderTopWidth)||0,l=0,u=0,d=r;for(;d&&d!==e;)l+=d.offsetLeft,u+=d.offsetTop,d=d.offsetParent;let f=l+s,p=u+c,m=f,h=m+r.clientWidth,g=p,_=g+r.clientHeight;if(i===a){let e=au(r,i),n=f+e.x-r.scrollLeft,a=p+e.y-r.scrollTop;if(Math.floor(Date.now()/500)%2==0&&n>=m&&n<=h&&a>=g&&a+e.height<=_){let r=document.createElement(`div`);r.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),r.style.cssText=`position:absolute;pointer-events:none;left:${n}px;top:${a}px;width:2px;height:${e.height}px;background:currentColor;`,t.appendChild(r)}}else{let e=au(r,i),n=au(r,a),o=e.height,s=r.scrollLeft,c=r.scrollTop;if(e.y===n.y){let r=Math.max(f+e.x-s,m),i=Math.min(f+n.x-s,h),a=p+e.y-c;if(i>r&&a>=g&&a+o<=_){let e=document.createElement(`div`);e.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),e.style.cssText=`position:absolute;pointer-events:none;left:${r}px;top:${a}px;width:${i-r}px;height:${o}px;background:Highlight;opacity:0.5;`,t.appendChild(e)}}else{let r=[];r.push({left:f+e.x-s,right:h,top:p+e.y-c});for(let t=e.y+o;t<n.y;t+=o)r.push({left:m,right:h,top:p+t-c});r.push({left:m,right:f+n.x-s,top:p+n.y-c});for(let e of r){let n=Math.max(e.left,m),r=Math.min(e.right,h);if(r<=n||e.top+o<g||e.top>_)continue;let i=document.createElement(`div`);i.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),i.style.cssText=`position:absolute;pointer-events:none;left:${n}px;top:${e.top}px;width:${r-n}px;height:${o}px;background:Highlight;opacity:0.5;`,t.appendChild(i)}}}}function su(e,t){let n=window.getSelection();if(!n||n.isCollapsed||n.rangeCount===0)return;let r=n.getRangeAt(0);if(!e.contains(r.startContainer)&&!e.contains(r.endContainer))return;let i=e.style.transform,a=e.style.transformOrigin;e.style.transform=`none`,e.style.transformOrigin=``;let o=e.getBoundingClientRect(),s=e.offsetWidth/o.width,c=e.offsetHeight/o.height,l=e.offsetWidth,u=e.offsetHeight,d=r.getClientRects(),f=[];for(let t=0;t<d.length;t++){let n=d[t];f.push({left:(n.left-o.left)*s+e.scrollLeft,top:(n.top-o.top)*c+e.scrollTop,width:n.width*s,height:n.height*c})}e.style.transform=i,e.style.transformOrigin=a;for(let e=0;e<f.length;e++){let{left:n,top:r,width:i,height:a}=f[e];if(n<0&&(i+=n,n=0),r<0&&(a+=r,r=0),n+i>l&&(i=l-n),r+a>u&&(a=u-r),i<=0||a<=0)continue;let o=document.createElement(`div`);o.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),o.style.cssText=`position:absolute;pointer-events:none;left:${n}px;top:${r}px;width:${i}px;height:${a}px;background:Highlight;opacity:0.5;`,t.appendChild(o)}}function cu(e,t){let n=[e,...e.querySelectorAll(`*`)],r=[t,...t.querySelectorAll(`*`)];if(n.length===r.length)for(let e=0;e<n.length;e++){let t=getComputedStyle(n[e]);for(let n of[`fontSize`,`lineHeight`,`height`,`minHeight`,`maxHeight`,`marginTop`,`marginBottom`,`paddingTop`,`paddingBottom`,`borderTopWidth`,`borderBottomWidth`]){let i=parseFloat(t[n]);isNaN(i)||(r[e].style[n]=i%1==0?t[n]:Math.floor(i)+`px`)}}}var lu=new Map;function uu(e){let t=lu.get(e);if(t)return t;let n=fetch(e).then(t=>{if(!t.ok)throw Error(`fetch ${e} → ${t.status}`);return t.blob()}).then(e=>new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(r.result),r.onerror=()=>n(r.error),r.readAsDataURL(e)}));return lu.set(e,n),n.catch(()=>{lu.get(e)===n&&lu.delete(e)}),n}async function du(e){let t=Array.from(e.querySelectorAll(`img`));await Promise.all(t.map(async e=>{let t=e.getAttribute(`src`);if(!(!t||t.startsWith(`data:`)))try{let n=new URL(t,document.baseURI).href;e.setAttribute(`src`,await uu(n))}catch(n){console.warn(`[HtmlRenderer] failed to inline img`,t,n),e.removeAttribute(`src`)}}))}var fu=new Map,pu=new Gl,mu=!1;function hu(){return pu}var gu=[],_u=[],vu=new WeakMap,yu=null;function bu(e={}){if(mu)return;if(window.__HTML_IN_CANVAS_POLYFILL__){let e=window.__HIC_UNINSTALL__;if(typeof e==`function`)e();else return}let t=`drawElementImage`in CanvasRenderingContext2D.prototype&&`requestPaint`in HTMLCanvasElement.prototype&&`onpaint`in HTMLCanvasElement.prototype,n=e.force??new URLSearchParams(location.search).has(`polyfillHIC`);if(t&&!n){console.info(`[html-in-canvas] Native API detected, polyfill skipped. Add ?polyfillHIC to URL to force.`);return}mu=!0,window.__HTML_IN_CANVAS_POLYFILL__=!0,window.__HIC_UNINSTALL__=xu,console.info(`[html-in-canvas] Polyfill installed`+(n?` (forced)`:``)),e.pageStyles&&pu.setPageStyles(e.pageStyles),wu(),Eu(),Ou(),Nu(),Hu(),Wu()}function xu(){if(mu){for(let e of Array.from(fu.values()))Qu(e);fu.clear();for(let[e,t,n]of gu)n?Object.defineProperty(e,t,n):delete e[t];gu.length=0;for(let[e,t,n,r]of _u)e.removeEventListener(t,n,r);_u.length=0,yu?.disconnect(),yu=null,Au=null,pu.cleanup(),mu=!1,window.__HTML_IN_CANVAS_POLYFILL__=!1,delete window.__HIC_UNINSTALL__}}function Su(e,t){let n=fu.get(e)||Gu(e);if(!n)throw new DOMException(`canvas is not [layoutsubtree]`,`InvalidStateError`);if(!n.children.has(t))throw new DOMException(`element is not a direct child of the canvas`,`InvalidStateError`);return n}function Cu(e,t,n,r,i,a){let o=new DOMMatrix().scale(n,r),s=new DOMMatrix().scale(1/n,1/r),c=getComputedStyle(e).transformOrigin.split(` `),l=parseFloat(c[0])||i/2,u=parseFloat(c[1])||a/2,d=new DOMMatrix().translate(l,u);return new DOMMatrix().translate(-l,-u).multiply(s).multiply(t).multiply(o).multiply(d)}function wu(){Vu(CanvasRenderingContext2D.prototype,`drawElementImage`,{configurable:!0,writable:!0,value:Tu})}function Tu(e,t,n,r,i){let a=this.canvas;Su(a,e);let o=pu.getCanvas(e),s=pu.getCssSize(e);if(!o||!s)return new DOMMatrix;let c=s.width,l=s.height,u=a.width/Math.max(1,a.clientWidth),d=a.height/Math.max(1,a.clientHeight),f=r??c*u,p=i??l*d;return this.drawImage(o,t,n,f,p),Cu(e,this.getTransform().translate(t,n).scale(f/(c*u),p/(l*d)),u,d,c,l)}function Eu(){typeof WebGLRenderingContext<`u`&&Vu(WebGLRenderingContext.prototype,`texElementImage2D`,{configurable:!0,writable:!0,value:Du}),typeof WebGL2RenderingContext<`u`&&Vu(WebGL2RenderingContext.prototype,`texElementImage2D`,{configurable:!0,writable:!0,value:Du})}function Du(e,t,n,...r){let i,a,o;if(r.length===3)[i,a,o]=r;else if(r.length===5)console.warn(`[html-in-canvas polyfill] texElementImage2D(width,height,...) overload: dest resize not implemented, uploading at bitmap size`),[,,i,a,o]=r;else if(r.length===7)console.warn(`[html-in-canvas polyfill] texElementImage2D(sx,sy,swidth,sheight,...) overload: source crop not implemented, uploading full bitmap`),[,,,,i,a,o]=r;else if(r.length===9)console.warn(`[html-in-canvas polyfill] texElementImage2D(sx,sy,swidth,sheight,width,height,...) overload: source crop + dest resize not implemented, uploading full bitmap`),[,,,,,,i,a,o]=r;else throw TypeError(`texElementImage2D: unexpected argument count ${3+r.length}`);if(!(o instanceof HTMLElement))throw TypeError(`texElementImage2D: element must be an HTMLElement`);let s=pu.getCanvas(o);if(!s)throw new DOMException("texElementImage2D: no snapshot recorded yet for this element. Call from inside the canvas `onpaint` handler or after at least one `requestPaint()` + rAF cycle.",`InvalidStateError`);this.texImage2D(e,t,n,i,a,s)}function Ou(){let e=globalThis.GPUQueue;!e||!e.prototype||Vu(e.prototype,`copyElementImageToTexture`,{configurable:!0,writable:!0,value:ku})}function ku(...e){let t,n,r,i;if(e.length===2)[t,n]=e,r=0,i=0;else if(e.length===4)[t,r,i,n]=e;else throw TypeError(`copyElementImageToTexture: expected 2 or 4 args, got ${e.length}`);if(!(t instanceof HTMLElement))throw TypeError(`copyElementImageToTexture: source must be an HTMLElement`);let a=pu.getCanvas(t);if(!a)throw new DOMException("copyElementImageToTexture: no snapshot recorded yet for this element. Call from inside the canvas `onpaint` handler or after at least one `requestPaint()` + rAF cycle.",`InvalidStateError`);r===0&&(r=a.width),i===0&&(i=a.height);let o=a;if(a.width!==r||a.height!==i){o=ju(r,i);let e=o.getContext(`2d`);e.clearRect(0,0,r,i),e.imageSmoothingEnabled=!0,e.imageSmoothingQuality=`high`,e.drawImage(a,0,0,r,i)}this.copyExternalImageToTexture({source:o},n,[r,i])}var Au=null;function ju(e,t){return Au||=document.createElement(`canvas`),Au.width!==e&&(Au.width=e),Au.height!==t&&(Au.height=t),Au}function Mu(e,t){let n=this;Su(n,e);let r=pu.getCssSize(e);if(!r)throw new DOMException(`no snapshot recorded yet`,`InvalidStateError`);return Cu(e,t,n.width/Math.max(1,n.clientWidth),n.height/Math.max(1,n.clientHeight),r.width,r.height)}function Nu(){Vu(HTMLCanvasElement.prototype,`layoutSubtree`,{configurable:!0,get(){return this.hasAttribute(`layoutsubtree`)},set(e){e?this.setAttribute(`layoutsubtree`,``):this.removeAttribute(`layoutsubtree`)}}),Vu(HTMLCanvasElement.prototype,`onpaint`,{configurable:!0,get(){return fu.get(this)?.onpaint??null},set(e){let t=Gu(this);t?t.onpaint=e:e&&console.warn("[html-in-canvas polyfill] setting onpaint on a canvas without `layoutsubtree` — the handler will never fire. Add the `layoutsubtree` attribute first.")}}),Vu(HTMLCanvasElement.prototype,`requestPaint`,{configurable:!0,writable:!0,value:function(){let e=Gu(this);if(e){for(let t of e.children)e.dirty.add(t);ed(e,`requestPaint`)}}}),Vu(HTMLCanvasElement.prototype,`getElementTransform`,{configurable:!0,writable:!0,value:Mu}),Vu(HTMLCanvasElement.prototype,`captureElementImage`,{configurable:!0,writable:!0,value:function(e){Su(this,e);let t=pu.getCanvas(e);if(!t)throw new DOMException(`no snapshot recorded yet`,`InvalidStateError`);return t}}),Pu(`children`,e=>e.children),Pu(`firstElementChild`,e=>e.firstElementChild),Pu(`lastElementChild`,e=>e.lastElementChild),Pu(`childElementCount`,e=>e.childElementCount),Lu(),Ru(),Bu()}function Pu(e,t){let n=Object.getOwnPropertyDescriptor(Element.prototype,e);Vu(HTMLCanvasElement.prototype,e,{configurable:!0,get(){let e=fu.get(this);return e&&this.hasAttribute(`layoutsubtree`)?t(e.host):n.get.call(this)}})}function Fu(e,t,n){e.children.has(t)||(n?e.host.insertBefore(t,n):e.host.appendChild(t),t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.opacity=`0`,t.style.pointerEvents=`auto`,e.children.add(t),e.dirty.add(t),vu.set(t,e.canvas),ed(e,`addChildToState`))}function Iu(e,t){return e.children.has(t)?(e.host.removeChild(t),e.children.delete(t),e.dirty.delete(t),vu.delete(t),t.style.removeProperty(`position`),t.style.removeProperty(`left`),t.style.removeProperty(`top`),t.style.removeProperty(`opacity`),t.style.removeProperty(`pointer-events`),t.style.removeProperty(`transform-origin`),!0):!1}function Lu(){let e=Node.prototype.appendChild;Vu(HTMLCanvasElement.prototype,`appendChild`,{configurable:!0,writable:!0,value:function(t){let n=fu.get(this);return n&&this.hasAttribute(`layoutsubtree`)&&t instanceof HTMLElement?(Fu(n,t),t):e.call(this,t)}});let t=Node.prototype.removeChild;Vu(HTMLCanvasElement.prototype,`removeChild`,{configurable:!0,writable:!0,value:function(e){let n=fu.get(this);return n&&e instanceof HTMLElement&&Iu(n,e)?e:t.call(this,e)}});let n=Node.prototype.insertBefore;Vu(HTMLCanvasElement.prototype,`insertBefore`,{configurable:!0,writable:!0,value:function(e,t){let r=fu.get(this);return r&&this.hasAttribute(`layoutsubtree`)&&e instanceof HTMLElement?(Fu(r,e,t),e):n.call(this,e,t)}}),Vu(HTMLCanvasElement.prototype,`contains`,{configurable:!0,writable:!0,value:function(e){let t=fu.get(this);return t&&e&&t.host.contains(e)?!0:Node.prototype.contains.call(this,e)}})}function Ru(){for(let e of[`parentNode`,`parentElement`]){let t=Object.getOwnPropertyDescriptor(Node.prototype,e);Vu(Node.prototype,e,{configurable:!0,get(){return vu.get(this)??t.get.call(this)}})}}var zu=new Set([`mousemove`,`mousedown`,`mouseup`,`mouseenter`,`mouseleave`,`mouseover`,`mouseout`,`click`,`dblclick`,`contextmenu`,`wheel`,`pointerdown`,`pointerup`,`pointermove`,`pointerenter`,`pointerleave`,`pointerover`,`pointerout`]);function Bu(){let e=EventTarget.prototype.addEventListener,t=EventTarget.prototype.removeEventListener,n=new WeakMap;Vu(HTMLCanvasElement.prototype,`addEventListener`,{configurable:!0,writable:!0,value:function(t,r,i){e.call(this,t,r,i);let a=fu.get(this);if(a&&zu.has(t)&&r){let o=typeof r==`function`?r.bind(this):r;n.set(r,o),e.call(a.host,t,o,i)}}}),Vu(HTMLCanvasElement.prototype,`removeEventListener`,{configurable:!0,writable:!0,value:function(e,r,i){t.call(this,e,r,i);let a=fu.get(this);if(a&&zu.has(e)&&r){let o=n.get(r);o&&(t.call(a.host,e,o,i),n.delete(r))}}})}function Vu(e,t,n){gu.push([e,t,Object.getOwnPropertyDescriptor(e,t)]),Object.defineProperty(e,t,n)}function Hu(){let e=()=>{for(let e of fu.values())e.positionHost()};Uu(window,`scroll`,e,{passive:!0}),Uu(window,`resize`,e)}function Uu(e,t,n,r){e.addEventListener(t,n,r),_u.push([e,t,n,r])}function Wu(){let e=()=>{mu&&document.querySelectorAll(`canvas[layoutsubtree]`).forEach(Gu)};document.readyState===`loading`?Uu(document,`DOMContentLoaded`,e,{once:!0}):e(),yu=new MutationObserver(e=>{for(let t of e)if(t.type===`attributes`&&t.attributeName===`layoutsubtree`){let e=t.target;if(!(e instanceof HTMLCanvasElement))continue;if(e.hasAttribute(`layoutsubtree`))Gu(e);else{let t=fu.get(e);t&&(Qu(t),fu.delete(e))}}else if(t.type===`childList`)for(let e of Array.from(t.addedNodes))e instanceof HTMLCanvasElement&&e.hasAttribute(`layoutsubtree`)?Gu(e):e instanceof Element&&e.querySelectorAll(`canvas[layoutsubtree]`).forEach(Gu)}),yu.observe(document.documentElement,{attributes:!0,subtree:!0,attributeFilter:[`layoutsubtree`],childList:!0})}function Gu(e){let t=fu.get(e);if(t)return t;if(!e.hasAttribute(`layoutsubtree`))return null;let n=Ku(e),r=new Set,i=new Set,a=[],o=()=>{let t=e.getBoundingClientRect();n.style.left=t.left+window.scrollX+e.clientLeft+`px`,n.style.top=t.top+window.scrollY+e.clientTop+`px`,n.style.width=e.clientWidth+`px`,n.style.height=e.clientHeight+`px`},s={canvas:e,host:n,children:r,dirty:i,onpaint:null,rafHandle:0,caretBlinkInterval:null,positionHost:o,observers:a,cleanups:[]};return qu(n,s),fu.set(e,s),Xu(s),o(),Zu(s),s}function Ku(e){let t=document.createElement(`div`);return t.setAttribute(`data-html-in-canvas-host`,``),e.className&&(t.className=e.className),e.id&&t.setAttribute(`data-host-of`,e.id),t.style.cssText=`position:absolute;left:0;top:0;margin:0;padding:0;pointer-events:auto;transform-style:preserve-3d;`,document.body.appendChild(t),t}function qu(e,t){let n=(e=`hostListener`)=>{for(let e of t.children)t.dirty.add(e);ed(t,e)};e.addEventListener(`load`,e=>{e.target instanceof HTMLImageElement&&n(`image-load`)},!0),e.addEventListener(`input`,()=>n(`input`),!0),e.addEventListener(`change`,()=>n(`change`),!0);let r=()=>{let t=window.getSelection(),r=t&&!t.isCollapsed&&t.rangeCount>0&&e.contains(t.getRangeAt(0).startContainer);(e.contains(document.activeElement)||r)&&n(`selectionchange`)};document.addEventListener(`selectionchange`,r),t.cleanups.push(()=>document.removeEventListener(`selectionchange`,r)),e.addEventListener(`mouseover`,t=>{let n=t.target;if(n.classList){n.classList.add(`pseudo-hover`);for(let t of Ju(n,e))t.classList.add(`pseudo-hover`)}},!0),e.addEventListener(`mouseout`,e=>{let t=e.target;if(t.classList){t.classList.remove(`pseudo-hover`);for(let e of t.querySelectorAll(`.pseudo-hover`))e.classList.remove(`pseudo-hover`)}},!0),e.addEventListener(`focusin`,r=>{let i=r.target;if(i.classList){i.classList.add(`pseudo-focus`);for(let t of Ju(i,e))t.classList.add(`pseudo-focus-within`);try{i.matches(`:focus-visible`)&&i.classList.add(`pseudo-focus-visible`)}catch{}(i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement)&&(t.caretBlinkInterval&&clearInterval(t.caretBlinkInterval),t.caretBlinkInterval=setInterval(()=>n(`caret-blink`),500))}},!0),e.addEventListener(`focusout`,r=>{let i=r.target;i.classList&&i.classList.remove(`pseudo-focus`,`pseudo-focus-visible`);for(let t of e.querySelectorAll(`.pseudo-focus-within`))t.classList.remove(`pseudo-focus-within`);t.caretBlinkInterval&&(clearInterval(t.caretBlinkInterval),t.caretBlinkInterval=null,n(`caret-remove`))},!0),e.addEventListener(`pointerdown`,t=>{let n=t.target;if(n.classList){n.classList.add(`pseudo-active`);for(let t of Ju(n,e))t.classList.add(`pseudo-active`)}},!0);let i=()=>{for(let t of e.querySelectorAll(`.pseudo-active`))t.classList.remove(`pseudo-active`)};e.addEventListener(`pointerup`,i,!0),e.addEventListener(`pointercancel`,i,!0)}function Ju(e,t){let n=[],r=e.parentElement;for(;r&&r!==t;)n.push(r),r=r.parentElement;return n}var Yu=Object.getOwnPropertyDescriptor(Element.prototype,`children`).get;function Xu(e){for(let t of Array.from(Yu.call(e.canvas)))Fu(e,t)}function Zu(e){let t=new ResizeObserver(()=>{e.positionHost();for(let t of e.children)e.dirty.add(t);ed(e,`ResizeObserver`)});t.observe(e.canvas),e.observers.push(t);let n=new MutationObserver(t=>{let n=!1;for(let r of t){let t=r.target;for(;t&&!(t instanceof HTMLElement&&e.children.has(t));)t=t.parentNode;t&&(e.dirty.add(t),n=!0)}n&&ed(e,`MutationObserver`)});n.observe(e.host,{childList:!0,subtree:!0,attributes:!0,characterData:!0}),e.observers.push(n)}function Qu(e){e.rafHandle&&=(cancelAnimationFrame(e.rafHandle),0),e.caretBlinkInterval&&=(clearInterval(e.caretBlinkInterval),null);for(let t of e.cleanups)t();e.cleanups.length=0;for(let t of e.observers)t.disconnect();e.observers.length=0,e.dirty.clear(),e.onpaint=null;let t=[`pseudo-hover`,`pseudo-focus`,`pseudo-focus-visible`,`pseudo-focus-within`,`pseudo-active`];for(let n of Array.from(e.children)){n.classList.remove(...t);for(let e of n.querySelectorAll(`.pseudo-hover, .pseudo-focus, .pseudo-focus-visible, .pseudo-focus-within, .pseudo-active`))e.classList.remove(...t);Iu(e,n),Node.prototype.appendChild.call(e.canvas,n)}e.host.remove()}var $u=typeof location<`u`&&new URLSearchParams(location.search).has(`debugPolyfillHIC`);function ed(e,t){$u&&t&&console.trace(`[html-in-canvas debug] schedulePaint from:`,t),!e.rafHandle&&(e.rafHandle=requestAnimationFrame(async()=>{var t;if(e.rafHandle=0,!fu.has(e.canvas))return;e.positionHost();let n=Array.from(e.dirty);if(e.dirty.clear(),n.length&&await Promise.all(n.map(td)),!fu.has(e.canvas))return;let r=new Event(`paint`);r.changedElements=n;try{(t=e.onpaint)==null||t.call(e.canvas,r)}catch(e){console.error(`[html-in-canvas polyfill] onpaint threw`,e)}e.canvas.dispatchEvent(r)}))}async function td(e){try{await pu.update(e)}catch(t){console.error(`[html-in-canvas polyfill] rasterize failed for ${nd(e)}:`,t instanceof Error?t.message+`
`+t.stack:t)}}function nd(e){let t=e.tagName.toLowerCase(),n=e.id?`#${e.id}`:``,r=e.getAttribute(`class`)||``;return`<${t}${n}${r?`.${r.trim().replace(/\s+/g,`.`)}`:``}>`}function rd(){if(!window.__HTML_IN_CANVAS_POLYFILL__)return;let e=[globalThis.WebGLRenderingContext,globalThis.WebGL2RenderingContext];for(let t of e){if(!t)continue;let e=t.prototype,n=e.texElementImage2D;!n||n.length!==3||Object.defineProperty(e,"texElementImage2D",{configurable:!0,writable:!0,value:function(e,t,r,i,a,o){n.call(this,e,t,r,i,a,o)}})}}var id=e({MoriaLightCanvas:()=>cd}),ad=new J(0,-1,0),od=new J(0,1,0),sd=ad.clone();function cd({onReady:e,onError:t}){let n=(0,i.useRef)(null),r=(0,i.useRef)(null),s=(0,i.useRef)(null),c=(0,i.useRef)(new Z),u=(0,i.useRef)(null),[d,f]=(0,i.useState)(o),h=(0,i.useRef)(d),[g,_]=(0,i.useState)(!1),[v,y]=(0,i.useState)(!1),[b,S]=(0,i.useState)(``);return(0,i.useEffect)(()=>{let e=!0;n.current?.setAttribute(`layoutsubtree`,``);try{bu();let t=window.innerWidth<760?2.5:3;hu().pixelRatio=Math.max(t,window.devicePixelRatio||1),rd(),queueMicrotask(()=>{e&&_(!0)})}catch(n){console.error(`HTML-in-Canvas could not be initialized.`,n),queueMicrotask(()=>{e&&(S(`HTML-in-Canvas is not available in this browser.`),t?.())})}return()=>{e=!1}},[t]),(0,i.useEffect)(()=>{if(!g)return;let i=n.current,c=r.current;if(!i||!c)return;let l=!1,d=0,p=0,m=0,_=0,v=null,b=performance.now(),C=0,w=0,T=!1,E=-1,D=0,O=0,k=-1,A=0,j=0,ee=o.angle,M=!1,te=1/120,N=1.22,ne=1,re=new J(0,-9.81,0),ie=new J(0,4.72,1.18),P=new J(.16,ie.y-N,ie.z+.08),ae=P.clone().add(new J(.018,0,-.012)),F=new J(0,.3,.08),oe=new J,se=F.clone(),I=new J,ce=new J,le=new J,ue=new J,de=new J,fe=new J,pe=sd.clone(),me=new J,he=new Lt,ge=new Lt,_e=new Lt,ve=new q,ye=new J,be=new ji(new J(0,0,1),-.08),xe=new co,Se;try{Se=new kl({canvas:i,antialias:!0,alpha:!0,powerPreference:`high-performance`})}catch(e){console.error(e);let n=window.setTimeout(()=>{l||(S(`This experience needs WebGL to render the Moria light study.`),t?.())},0);return()=>{l=!0,window.clearTimeout(n)}}Se.outputColorSpace=Ye,Se.toneMapping=7,Se.toneMappingExposure=1.08,Se.setClearColor(66052,1);let Ce=new Hn;Ce.background=new Z(66052);let we=new La(37,1,.1,80);we.position.set(0,.2,13.6);let Te=new Pn;Te.position.set(0,-.35,0),Ce.add(Te);let Ee=new Ri(c);Ee.colorSpace=Ye,Ee.minFilter=x,Ee.magFilter=x,Ee.generateMipmaps=!1;let De=new Ki(1,1,1,1),Oe=new aa({map:Ee,color:12962516,roughness:.96,metalness:0,transparent:!0,alphaTest:.005,side:0}),ke=new wi(De,Oe);Te.add(ke);let Ae=new aa({color:526864,roughness:.9,metalness:.03}),je=new wi(new Ki(1.018,1.028),Ae);je.position.z=-.035,Te.add(je);let L=new Ta(7438491,1380632,.58);Ce.add(L);let Me=new Wa(9545416,.24);Me.position.set(-4.8,5.6,7.4),Ce.add(Me);let R=new Pn;Ce.add(R);let Ne=new wi(new Wi(.24,.3,.11,24),new aa({color:1053208,roughness:.64,metalness:.7}));Ne.position.copy(ie).add(new J(0,.08,0)),Ce.add(Ne);let z=new wi(new Wi(.014,.014,1,10),new aa({color:1184536,roughness:.5,metalness:.55}));Ce.add(z);let Pe=new Pn;R.add(Pe);let B=[new q(.08,.08),new q(.18,.02),new q(.43,-.1),new q(.82,-.25),new q(1.08,-.36),new q(1.1,-.41)],V=new aa({color:1052950,roughness:.36,metalness:.74,side:2}),Fe=new wi(new Gi(B,48),V);Pe.add(Fe);let Ie=new wi(new Ji(1.095,.027,8,48),new aa({color:1513759,roughness:.28,metalness:.82}));Ie.rotation.x=Math.PI/2,Ie.position.y=-.397,Pe.add(Ie);let Le=new aa({color:new Z(o.color).multiplyScalar(.18),emissive:o.color,emissiveIntensity:.42,roughness:.92,side:2}),Re=new wi(new Ui(1.055,48),Le);Re.rotation.x=Math.PI/2,Re.position.y=-.385,Pe.add(Re);let ze=new wi(new Wi(.095,.12,.2,20),new aa({color:10250052,roughness:.44,metalness:.66}));ze.position.y=.08,Pe.add(ze);let Be=new aa({color:16766893,emissive:o.color,emissiveIntensity:3.2,roughness:.2}),Ve=new wi(new qi(.16,20,12),Be);Ve.scale.y=1.2,Ve.position.y=-.33,Pe.add(Ve);let He=Je(),Ue=new Hr({map:He,color:o.color,transparent:!0,opacity:.86,depthWrite:!1,blending:2}),We=new ni(Ue);We.position.y=-.36,We.scale.set(.96,.96,.96),Pe.add(We);let Ge=new za(o.color,1,18,It.degToRad(o.angle),.88,2);Ge.power=o.brightness,Ge.position.set(0,-.35,0),Ge.target.position.set(0,-7,0),Pe.add(Ge,Ge.target);let Ke=new Va(o.color,1,3.2,2);Ke.power=36,Ke.position.set(0,-.35,0),Pe.add(Ke),s.current={spot:Ge,bulbLight:Ke,bulbMaterial:Be,glowMaterial:Ue,undersideMaterial:Le};let qe=new Pl;qe.connect(Se,we),qe.add(ke);function Je(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);if(t){let e=t.createRadialGradient(32,32,0,32,32,32);e.addColorStop(0,`rgba(255,255,255,1)`),e.addColorStop(.16,`rgba(255,222,172,.8)`),e.addColorStop(.46,`rgba(255,170,94,.22)`),e.addColorStop(1,`rgba(255,140,70,0)`),t.fillStyle=e,t.fillRect(0,0,64,64)}let n=new Li(e);return n.colorSpace=Ye,n}function Xe(e=!0){let t=Math.max(1,i.clientWidth),n=Math.max(1,i.clientHeight),r=Math.min(window.devicePixelRatio||1,t<760?1.5:2);Se.setPixelRatio(r),Se.setSize(t,n,!1),we.aspect=t/n,we.updateProjectionMatrix();let a=c.offsetWidth||t,o=c.offsetHeight||n,s=n>t*1.16,l=s?7.2:12.8,u=o/a*l;ke.scale.set(l,u,1),je.scale.set(l,u,1);let d=s?It.clamp(t*.3,110,200):It.clamp(Math.min(t*.17,n*.34),140,280),f=l/t,p=u/n;ne=d*f/2.2,R.scale.setScalar(ne),Ne.scale.setScalar(ne),N=It.clamp(n*(s?.13:.16),s?72:80,150)*p,Te.position.y=0;let m=s?18:12;if(ie.set(0,u/2-m*p,s?1.1:1.18),Ne.position.copy(ie),Ne.position.y+=.08*ne,!T){let e=I.copy(P).sub(ie);e.lengthSq()<.001&&e.copy(ad),e.normalize().multiplyScalar(N),P.copy(ie).add(e),ae.copy(P)}let h=It.degToRad(we.fov*.5),g=u/(2*Math.tan(h));we.position.set(0,0,g),we.lookAt(0,0,0),we.updateMatrixWorld(),qe.update(),i.requestPaint?.(),e&&H()}function Ze(){de.copy(P).sub(ie).normalize(),me.copy(ie).add(P).multiplyScalar(.5),z.position.copy(me),z.scale.set(ne,N,ne),_e.setFromUnitVectors(od,de),z.quaternion.copy(_e),T?(fe.copy(F).sub(P).normalize(),pe.lerp(fe,.32).normalize()):(he.setFromUnitVectors(ad,de),fe.copy(sd).applyQuaternion(he).normalize(),pe.lerp(fe,.14).normalize()),ge.setFromUnitVectors(ad,pe),R.position.copy(P),R.quaternion.copy(ge)}function Qe(){ue.copy(P).sub(ae).multiplyScalar(T?.985:.9948),ae.copy(P),P.add(ue).addScaledVector(re,te*te),T&&(ce.copy(F).sub(ie).normalize(),ce.lerp(ad,1-O*.82).normalize(),le.copy(ce).multiplyScalar(N).add(ie).sub(P),I.copy(P).sub(ie).normalize(),le.addScaledVector(I,-le.dot(I)),P.addScaledVector(le,52*te*te)),I.copy(P).sub(ie),I.lengthSq()<1e-8&&I.copy(ad),I.normalize().multiplyScalar(N),P.copy(ie).add(I),ue.copy(P).sub(ae),T?w=0:ue.lengthSq()<14e-9?w+=1:w=0}function $e(e){if(p=0,l)return;let t=Math.min((e-b)/1e3,.05);for(b=e,C=Math.min(C+t,te*5);C>=te;)Qe(),C-=te;Ze(),qe.update(),Se.render(Ce,we),d+=1,(T||w<80||d<4)&&(p=requestAnimationFrame($e))}function H(){w=0,!p&&!l&&(b=performance.now(),p=requestAnimationFrame($e))}u.current=H;function et(e){let t=i.getBoundingClientRect();ve.x=(e.clientX-t.left)/t.width*2-1,ve.y=-((e.clientY-t.top)/t.height)*2+1,xe.setFromCamera(ve,we)}function tt(e){if(et(e),!xe.ray.intersectPlane(be,F))return!1;ye.copy(P).project(we);let t=(ve.x-ye.x)*we.aspect,n=ve.y-ye.y,r=Math.sqrt(t*t+n*n);return O=It.smoothstep(r,.08,1.15),!0}function nt(e){if(e.button===2){k=e.pointerId,A=e.clientX,j=e.clientY,ee=h.current.angle,M=!1,c.classList.add(`is-adjusting-beam`);return}e.button!==0||k!==-1||tt(e)&&(T=!0,E=e.pointerId,D=performance.now(),se.copy(F),oe.set(0,0,0),i.classList.add(`is-pulling-light`),H())}function rt(e){if(e.pointerId===k){let t=e.clientX-A,n=e.clientY-j;if(!M&&Math.hypot(t,n)>=4&&(M=!0),M){let e=It.clamp(Math.round(ee+t*.14),16,60);f(t=>t.angle===e?t:{...t,angle:e}),H()}return}if(!T||e.pointerId!==E||!tt(e))return;let t=performance.now(),n=Math.max(.008,Math.min(.05,(t-D)/1e3));I.copy(F).sub(se).multiplyScalar(1/n),oe.lerp(I,.34),se.copy(F),D=t,H()}function it(e){if(e.pointerId===k){let t=!M&&e.type!==`pointercancel`;k=-1,M=!1,c.classList.remove(`is-adjusting-beam`),t&&f(e=>{let t=a[(a.findIndex(t=>t===e.color.toLowerCase())+1)%a.length];return{...e,color:t}}),H();return}if(!T||e.pointerId!==E)return;ue.copy(P).sub(ae).multiplyScalar(1/te),I.copy(P).sub(ie).normalize(),oe.addScaledVector(I,-oe.dot(I)).clampLength(0,6);let t=It.lerp(.055,.12,O);if(ue.addScaledVector(oe,t),ce.copy(ie).addScaledVector(ad,N).sub(P),ce.addScaledVector(I,-ce.dot(I)),ce.lengthSq()>1e-4){ce.normalize();let e=It.lerp(.32,1.6,O);ue.addScaledVector(ce,e)}ue.clampLength(0,4.25),ae.copy(P).addScaledVector(ue,-.008333333333333333),T=!1,E=-1,O=0,i.classList.remove(`is-pulling-light`),H()}function at(){T=!1,E=-1,O=0,P.copy(ie).addScaledVector(ad,N),ae.copy(P),oe.set(0,0,0),pe.copy(sd),i.classList.remove(`is-pulling-light`),k=-1,M=!1,c.classList.remove(`is-adjusting-beam`),H()}function ot(){cancelAnimationFrame(m),m=requestAnimationFrame(()=>Xe())}function st(){H()}function U(e){e.preventDefault()}i.addEventListener(`pointerdown`,nt),i.addEventListener(`dblclick`,at),i.addEventListener(`contextmenu`,U),window.addEventListener(`pointermove`,rt,{passive:!0}),window.addEventListener(`pointerup`,it),window.addEventListener(`pointercancel`,it),window.addEventListener(`resize`,ot,{passive:!0}),i.addEventListener(`paint`,st);function W(){let e=i.requestPaint;return e?new Promise((t,n)=>{v=()=>{window.clearTimeout(_),v=null,t()},_=window.setTimeout(()=>{v&&=(i.removeEventListener(`paint`,v),null),n(Error(`Timed out while preparing the interactive HTML surface.`))},3e4),i.addEventListener(`paint`,v,{once:!0}),e.call(i)}):Promise.resolve()}function ct(e){return e instanceof DOMException&&e.name===`InvalidStateError`&&e.message.includes(`snapshot`)}async function lt(){if(!l){Xe(!1),Ze(),qe.update();try{Se.render(Ce,we)}catch(e){if(!ct(e))throw e;if(await W(),l)return;Xe(!1),Ze(),qe.update(),Se.render(Ce,we)}d+=1,y(!0),e?.(),H()}}return document.fonts.ready.then(lt).catch(e=>{l||(console.error(`Interactive light initialization failed.`,e),S(`The interactive light could not be initialized in this browser.`),t?.())}),()=>{l=!0,cancelAnimationFrame(p),cancelAnimationFrame(m),window.clearTimeout(_),v&&i.removeEventListener(`paint`,v),i.removeEventListener(`pointerdown`,nt),i.removeEventListener(`dblclick`,at),i.removeEventListener(`contextmenu`,U),window.removeEventListener(`pointermove`,rt),window.removeEventListener(`pointerup`,it),window.removeEventListener(`pointercancel`,it),window.removeEventListener(`resize`,ot),i.removeEventListener(`paint`,st),qe.disconnect(),u.current=null,s.current=null,Ee.dispose(),De.dispose(),Oe.dispose(),je.geometry.dispose(),Ae.dispose(),Fe.geometry.dispose(),V.dispose(),Ie.geometry.dispose(),Ie.material.dispose(),Re.geometry.dispose(),Le.dispose(),ze.geometry.dispose(),ze.material.dispose(),Ve.geometry.dispose(),Be.dispose(),z.geometry.dispose(),z.material.dispose(),Ne.geometry.dispose(),Ne.material.dispose(),He.dispose(),Ue.dispose(),Se.dispose()}},[g,t,e]),(0,i.useEffect)(()=>{h.current=d;let e=s.current;if(!e)return;let t=c.current.set(d.color),r=d.enabled?d.brightness:0;e.spot.color.copy(t),e.spot.power=r,e.spot.angle=It.degToRad(d.angle),e.bulbLight.color.copy(t),e.bulbLight.power=d.enabled?Math.max(18,d.brightness*.026):0,e.bulbMaterial.emissive.copy(t),e.bulbMaterial.emissiveIntensity=d.enabled?2.4+d.brightness/850:.04,e.glowMaterial.color.copy(t),e.glowMaterial.opacity=d.enabled?.52+d.brightness/4200:0,e.undersideMaterial.color.copy(t).multiplyScalar(.18),e.undersideMaterial.emissive.copy(t),e.undersideMaterial.emissiveIntensity=d.enabled?.22+d.brightness/7250:.03,n.current?.requestPaint?.(),u.current?.()},[d]),(0,l.jsxs)(`main`,{className:`experience-shell${v?` is-ready`:``}`,"aria-label":`Interactive Moria light study`,"aria-busy":!v&&!b,children:[(0,l.jsx)(`canvas`,{ref:n,className:`webgl-canvas`,"aria-label":`Interactive Moria light study`,children:(0,l.jsx)(p,{sourceRef:r,lighting:d})}),(0,l.jsx)(m,{hidden:v||!!b}),(0,l.jsxs)(`div`,{className:`scene-status${v||b?` is-hidden`:``}`,"aria-live":`polite`,children:[(0,l.jsx)(`span`,{}),` PREPARING HTML SURFACE`]}),b?(0,l.jsx)(`div`,{className:`scene-error`,children:b}):null]})}export{r as a,o as i,p as n,c as r,id as t};