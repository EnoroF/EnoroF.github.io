...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function zo(e,t,n){let r=new Float32Array(To),i=new J(0,1,0);return new ta({name:`SphericalGaussianBlur`,defines:{n:To,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ho(),fragmentShader:`
...
`)}async update(e){let t=e.clientWidth||e.offsetWidth,n=e.clientHeight||e.offsetHeight;if(t===0||n===0){let t=this.entries.get(e);return t?t.canvas:this.ensureEntry(e,1,1).canvas}let r=this.ensureEntry(e,t,n),i=Math.max(1,this.pixelRatio),a=r.canvas.width,o=r.canvas.height,s=await this.buildSvg(e,t,n,i);if(s===r.lastSvg)return Hl&&console.log(`[html-in-canvas debug] rasterization skipped (unchanged)`),r.canvas;if(Hl&&r.lastSvg){let e=r.lastSvg.split(`<`),t=s.split(`<`),n=[],i=Math.max(e.length,t.length);for(let r=0;r<i;r++)if(e[r]!==t[r]&&(n.push(`  - ${(e[r]||``).slice(0,120)}`),n.push(`  + ${(t[r]||``).slice(0,120)}`)),n.length>20){n.push(`  ...`);break}console.log(`[html-in-canvas debug] SVG changed:
`+n.join(`
`))}r.lastSvg=s;let c=await Kl(s,a,o);return r.context.clearRect(0,0,a,o),r.context.drawImage(c,0,0,a,o),r.canvas}getCanvas(e){return this.entries.get(e)?.canvas??null}getCssSize(e){let t=this.entries.get(e);return t?{width:t.cssW,height:t.cssH}:null}setPageStyles(e){this.pageStyles=e}async getPageStylesCss(){if(!this.pageStylesCssPromise){let e=ql();this.pageStylesCssPromise=e,e.catch(()=>{this.pageStylesCssPromise===e&&(this.pageStylesCssPromise=null)})}return this.pageStylesCssPromise}invalidatePageStylesCss(){this.pageStylesCssPromise=null}cleanup(){this.entries.clear(),this.pageStylesCssPromise=null,su.clear(),nu&&=(nu.remove(),null)}captureDynamicStateOnClone(e,t){let n=[e,...e.querySelectorAll(`*`)],r=[t,...t.querySelectorAll(`*`)];if(n.length===r.length){for(let e=0;e<n.length;e++)eu(n[e],r[e]);iu(e,t),au(e,t)}}ensureEntry(e,t,n){let r=Math.max(1,this.pixelRatio),i=Math.max(1,Math.ceil(t*r)),a=Math.max(1,Math.ceil(n*r)),o=this.entries.get(e);if(o)(o.canvas.width!==i||o.canvas.height!==a)&&(o.canvas.width=i,o.canvas.height=a),o.cssW=t,o.cssH=n;else{let r=document.createElement(`canvas`);r.width=i,r.height=a,o={canvas:r,context:r.getContext(`2d`),cssW:t,cssH:n},this.entries.set(e,o)}return o}async buildSvg(e,t,n,r=1){let i=await Wl(e);this.captureDynamicStateOnClone(e,i);let a=Gl(e,new XMLSerializer().serializeToString(i)),o=await this.getPageStylesCss(),s=`<svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${n}" viewBox="0 0 ${t} ${n}"><style><![CDATA[${(Jl+`
`+o+`
`+this.pageStyles+`
`+this.svgOnlyStyles).replace(/]]>/g,`]]]]><![CDATA[>`)}]]></style><foreignObject x="0" y="0" width="100%" height="100%">${a}</foreignObject></svg>`;if(Hl){let e=document.getElementById(`__hic-svg-debug__`);e||(e=document.createElement(`div`),e.id=`__hic-svg-debug__`,e.style.cssText=`position:absolute;z-index:99999;pointer-events:none;opacity:0.3;box-sizing:border-box;margin:0;padding:0;border:none;overflow:hidden;`,document.body.appendChild(e));let t=document.querySelector(`canvas`);if(t){let n=t.getBoundingClientRect();e.style.left=n.left+window.scrollX+`px`,e.style.top=n.top+window.scrollY+`px`,e.style.width=n.width+`px`,e.style.height=n.height+`px`}if(!e.innerHTML){e.innerHTML=s;let t=e.querySelector(`svg`);t&&(t.style.width=`100%`,t.style.height=`100%`)}}return s}};async function Wl(e){let t=e.cloneNode(!0);return Vl(e,t),ou(e,t),t.style.removeProperty(`transform`),t.style.opacity=`1`,t.style.visibility=`visible`,await lu(t),t.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),t}function Gl(e,t){let n=e.parentElement,r=n?.getAttribute(`class`)||``,i=n?.clientWidth||e.clientWidth||e.offsetWidth,a=n?.clientHeight||e.clientHeight||e.offsetHeight;return`<html xmlns="http://www.w3.org/1999/xhtml" style="margin:0;padding:0;background:transparent !important;"><body style="margin:0;padding:0;background:transparent !important;"><div xmlns="http://www.w3.org/1999/xhtml"${r?` class="${$l(r)}"`:``} style="position:relative;width:${i}px;height:${a}px;margin:0;padding:0;">`+t+`</div></body></html>`}async function Kl(e,t,n){let r=`data:image/svg+xml;charset=UTF-8,`+encodeURIComponent(e);try{return await Il(r)}catch(r){let i=r&&typeof r==`object`&&`type`in r?r.type:typeof r,a=Error(`HtmlRenderer: SVG image failed to load (${i}). cssW=${t}, cssH=${n}, svg.length=${e.length}. svg head: ${e.slice(0,300).replace(/\s+/g,` `)}…`);throw a.cause=r,a.svg=e,a}}async function ql(){let e=[];for(let t of Array.from(document.styleSheets))try{let n=Array.from(t.cssRules||[]);e.push(n.map(e=>e.cssText).join(`
`))}catch{if(!t.href)continue;try{let n=await fetch(t.href);n.ok&&e.push(await n.text())}catch(e){console.warn(`[HtmlRenderer] failed to fetch stylesheet`,t.href,e)}}if(e.length===0)return``;let t;try{t=await Bl(e.join(`
`),async e=>{if(e.startsWith(`http://www.w3.org/`))return e;try{return await cu(e)}catch{return e}})}catch(n){console.warn(`[HtmlRenderer] URL embedding failed`,n),t=e.join(`
`)}let n=Zl(t);return n?t+`
`+n:t}var Jl=`
...
`,Yl=/:(?:hover|focus-visible|focus-within|focus(?!-)|active)\b/g,Xl=/:(?:hover|focus-visible|focus-within|focus(?!-)|active)\b/;function Zl(e){let t;try{t=new CSSStyleSheet,t.replaceSync(e)}catch{return``}let n=[];return Ql(t.cssRules,n),n.join(`
`)}function Ql(e,t){for(let n=0;n<e.length;n++){let r=e[n];if(r instanceof CSSStyleRule){if(Xl.test(r.selectorText)){let e=r.selectorText.replace(Yl,e=>`.pseudo-`+e.slice(1));t.push(`${e} { ${r.style.cssText} }`)}}else if(`cssRules`in r){let e=r,n=[];if(Ql(e.cssRules,n),n.length){let e=``;e=r instanceof CSSMediaRule?`@media ${r.conditionText}`:r instanceof CSSSupportsRule?`@supports ${r.conditionText}`:(r.cssText?.split(`{`)[0])?.trim()??``,e&&t.push(`${e} {
${n.join(`
`)}
}`)}}}}function $l(e){return e.replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function eu(e,t){(e.scrollLeft!==0||e.scrollTop!==0)&&(t.style.setProperty(`--scroll-left`,-e.scrollLeft+`px`),t.style.setProperty(`--scroll-top`,-e.scrollTop+`px`));let n=e.getAnimations();if(n.length!==1)return;let r=n[0],i=typeof r.currentTime==`number`?r.currentTime:0,a=getComputedStyle(e).animationDelay,o=((a.endsWith(`ms`)?parseFloat(a)/1e3:parseFloat(a))||0)-i/1e3;t.style.setProperty(`--animation-delay`,o+`s`)}var tu=`fontFamily.fontSize.fontWeight.fontStyle.fontVariant.lineHeight.letterSpacing.wordSpacing.textIndent.textTransform.whiteSpace.wordWrap.overflowWrap.wordBreak.paddingTop.paddingRight.paddingBottom.paddingLeft.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.boxSizing.width.direction.textAlign`.split(`.`),nu=null;function ru(e,t){nu||(nu=document.createElement(`div`),nu.style.cssText=`position:absolute;left:-9999px;top:-9999px;visibility:hidden;overflow:hidden;`,document.body.appendChild(nu));let n=getComputedStyle(e),r=e instanceof HTMLInputElement;for(let e of tu)nu.style[e]=n[e];nu.style.whiteSpace=r?`pre`:n.whiteSpace,nu.style.height=`auto`,nu.style.overflowY=`hidden`;let i=e.value,a=i.substring(0,t);nu.textContent=``;let o=document.createTextNode(a),s=document.createElement(`span`);s.textContent=`|`,nu.appendChild(o),nu.appendChild(s),nu.appendChild(document.createTextNode(i.substring(t)||`.`));let c=parseFloat(n.fontSize),l=parseFloat(n.lineHeight),u=isNaN(l)?c*1.2:n.lineHeight.endsWith(`px`)?l:l*c;return{x:s.offsetLeft,y:s.offsetTop,height:u}}function iu(e,t){let n=document.activeElement;if(!n)return;let r;if(n instanceof HTMLInputElement){let e=n.type;if(e!==`text`&&e!==`search`&&e!==`url`&&e!==`tel`&&e!==`password`&&e!==``)return;r=n}else if(n instanceof HTMLTextAreaElement)r=n;else return;if(!e.contains(r))return;let i=r.selectionStart,a=r.selectionEnd;if(i===null||a===null)return;let o=getComputedStyle(r),s=parseFloat(o.borderLeftWidth)||0,c=parseFloat(o.borderTopWidth)||0,l=0,u=0,d=r;for(;d&&d!==e;)l+=d.offsetLeft,u+=d.offsetTop,d=d.offsetParent;let f=l+s,p=u+c,m=f,h=m+r.clientWidth,g=p,_=g+r.clientHeight;if(i===a){let e=ru(r,i),n=f+e.x-r.scrollLeft,a=p+e.y-r.scrollTop;if(Math.floor(Date.now()/500)%2==0&&n>=m&&n<=h&&a>=g&&a+e.height<=_){let r=document.createElement(`div`);r.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),r.style.cssText=`position:absolute;pointer-events:none;left:${n}px;top:${a}px;width:2px;height:${e.height}px;background:currentColor;`,t.appendChild(r)}}else{let e=ru(r,i),n=ru(r,a),o=e.height,s=r.scrollLeft,c=r.scrollTop;if(e.y===n.y){let r=Math.max(f+e.x-s,m),i=Math.min(f+n.x-s,h),a=p+e.y-c;if(i>r&&a>=g&&a+o<=_){let e=document.createElement(`div`);e.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),e.style.cssText=`position:absolute;pointer-events:none;left:${r}px;top:${a}px;width:${i-r}px;height:${o}px;background:Highlight;opacity:0.5;`,t.appendChild(e)}}else{let r=[];r.push({left:f+e.x-s,right:h,top:p+e.y-c});for(let t=e.y+o;t<n.y;t+=o)r.push({left:m,right:h,top:p+t-c});r.push({left:m,right:f+n.x-s,top:p+n.y-c});for(let e of r){let n=Math.max(e.left,m),r=Math.min(e.right,h);if(r<=n||e.top+o<g||e.top>_)continue;let i=document.createElement(`div`);i.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),i.style.cssText=`position:absolute;pointer-events:none;left:${n}px;top:${e.top}px;width:${r-n}px;height:${o}px;background:Highlight;opacity:0.5;`,t.appendChild(i)}}}}function au(e,t){let n=window.getSelection();if(!n||n.isCollapsed||n.rangeCount===0)return;let r=n.getRangeAt(0);if(!e.contains(r.startContainer)&&!e.contains(r.endContainer))return;let i=e.style.transform,a=e.style.transformOrigin;e.style.transform=`none`,e.style.transformOrigin=``;let o=e.getBoundingClientRect(),s=e.offsetWidth/o.width,c=e.offsetHeight/o.height,l=e.offsetWidth,u=e.offsetHeight,d=r.getClientRects(),f=[];for(let t=0;t<d.length;t++){let n=d[t];f.push({left:(n.left-o.left)*s+e.scrollLeft,top:(n.top-o.top)*c+e.scrollTop,width:n.width*s,height:n.height*c})}e.style.transform=i,e.style.transformOrigin=a;for(let e=0;e<f.length;e++){let{left:n,top:r,width:i,height:a}=f[e];if(n<0&&(i+=n,n=0),r<0&&(a+=r,r=0),n+i>l&&(i=l-n),r+a>u&&(a=u-r),i<=0||a<=0)continue;let o=document.createElement(`div`);o.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),o.style.cssText=`position:absolute;pointer-events:none;left:${n}px;top:${r}px;width:${i}px;height:${a}px;background:Highlight;opacity:0.5;`,t.appendChild(o)}}function ou(e,t){let n=[e,...e.querySelectorAll(`*`)],r=[t,...t.querySelectorAll(`*`)];if(n.length===r.length)for(let e=0;e<n.length;e++){let t=getComputedStyle(n[e]);for(let n of[`fontSize`,`lineHeight`,`height`,`minHeight`,`maxHeight`,`marginTop`,`marginBottom`,`paddingTop`,`paddingBottom`,`borderTopWidth`,`borderBottomWidth`]){let i=parseFloat(t[n]);isNaN(i)||(r[e].style[n]=i%1==0?t[n]:Math.floor(i)+`px`)}}}var su=new Map;function cu(e){let t=su.get(e);if(t)return t;let n=fetch(e).then(t=>{if(!t.ok)throw Error(`fetch ${e} → ${t.status}`);return t.blob()}).then(e=>new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(r.result),r.onerror=()=>n(r.error),r.readAsDataURL(e)}));return su.set(e,n),n.catch(()=>{su.get(e)===n&&su.delete(e)}),n}async function lu(e){let t=Array.from(e.querySelectorAll(`img`));await Promise.all(t.map(async e=>{let t=e.getAttribute(`src`);if(!(!t||t.startsWith(`data:`)))try{let n=new URL(t,document.baseURI).href;e.setAttribute(`src`,await cu(n))}catch(n){console.warn(`[HtmlRenderer] failed to inline img`,t,n),e.removeAttribute(`src`)}}))}var uu=new Map,du=new Ul,fu=!1;function pu(){return du}var mu=[],hu=[],gu=new WeakMap,_u=null;function vu(e={}){if(fu)return;if(window.__HTML_IN_CANVAS_POLYFILL__){let e=window.__HIC_UNINSTALL__;if(typeof e==`function`)e();else return}let t=`drawElementImage`in CanvasRenderingContext2D.prototype&&`requestPaint`in HTMLCanvasElement.prototype&&`onpaint`in HTMLCanvasElement.prototype,n=e.force??new URLSearchParams(location.search).has(`polyfillHIC`);if(t&&!n){console.info(`[html-in-canvas] Native API detected, polyfill skipped. Add ?polyfillHIC to URL to force.`);return}fu=!0,window.__HTML_IN_CANVAS_POLYFILL__=!0,window.__HIC_UNINSTALL__=yu,console.info(`[html-in-canvas] Polyfill installed`+(n?` (forced)`:``)),e.pageStyles&&du.setPageStyles(e.pageStyles),Su(),wu(),Eu(),ju(),Bu(),Hu()}function yu(){if(fu){for(let e of Array.from(uu.values()))Xu(e);uu.clear();for(let[e,t,n]of mu)n?Object.defineProperty(e,t,n):delete e[t];mu.length=0;for(let[e,t,n,r]of hu)e.removeEventListener(t,n,r);hu.length=0,_u?.disconnect(),_u=null,Ou=null,du.cleanup(),fu=!1,window.__HTML_IN_CANVAS_POLYFILL__=!1,delete window.__HIC_UNINSTALL__}}function bu(e,t){let n=uu.get(e)||Uu(e);if(!n)throw new DOMException(`canvas is not [layoutsubtree]`,`InvalidStateError`);if(!n.children.has(t))throw new DOMException(`element is not a direct child of the canvas`,`InvalidStateError`);return n}function xu(e,t,n,r,i,a){let o=new DOMMatrix().scale(n,r),s=new DOMMatrix().scale(1/n,1/r),c=getComputedStyle(e).transformOrigin.split(` `),l=parseFloat(c[0])||i/2,u=parseFloat(c[1])||a/2,d=new DOMMatrix().translate(l,u);return new DOMMatrix().translate(-l,-u).multiply(s).multiply(t).multiply(o).multiply(d)}function Su(){zu(CanvasRenderingContext2D.prototype,`drawElementImage`,{configurable:!0,writable:!0,value:Cu})}function Cu(e,t,n,r,i){let a=this.canvas;bu(a,e);let o=du.getCanvas(e),s=du.getCssSize(e);if(!o||!s)return new DOMMatrix;let c=s.width,l=s.height,u=a.width/Math.max(1,a.clientWidth),d=a.height/Math.max(1,a.clientHeight),f=r??c*u,p=i??l*d;return this.drawImage(o,t,n,f,p),xu(e,this.getTransform().translate(t,n).scale(f/(c*u),p/(l*d)),u,d,c,l)}function wu(){typeof WebGLRenderingContext<`u`&&zu(WebGLRenderingContext.prototype,`texElementImage2D`,{configurable:!0,writable:!0,value:Tu}),typeof WebGL2RenderingContext<`u`&&zu(WebGL2RenderingContext.prototype,`texElementImage2D`,{configurable:!0,writable:!0,value:Tu})}function Tu(e,t,n,...r){let i,a,o;if(r.length===3)[i,a,o]=r;else if(r.length===5)console.warn(`[html-in-canvas polyfill] texElementImage2D(width,height,...) overload: dest resize not implemented, uploading at bitmap size`),[,,i,a,o]=r;else if(r.length===7)console.warn(`[html-in-canvas polyfill] texElementImage2D(sx,sy,swidth,sheight,...) overload: source crop not implemented, uploading full bitmap`),[,,,,i,a,o]=r;else if(r.length===9)console.warn(`[html-in-canvas polyfill] texElementImage2D(sx,sy,swidth,sheight,width,height,...) overload: source crop + dest resize not implemented, uploading full bitmap`),[,,,,,,i,a,o]=r;else throw TypeError(`texElementImage2D: unexpected argument count ${3+r.length}`);if(!(o instanceof HTMLElement))throw TypeError(`texElementImage2D: element must be an HTMLElement`);let s=du.getCanvas(o);if(!s)throw new DOMException("texElementImage2D: no snapshot recorded yet for this element. Call from inside the canvas `onpaint` handler or after at least one `requestPaint()` + rAF cycle.",`InvalidStateError`);this.texImage2D(e,t,n,i,a,s)}function Eu(){let e=globalThis.GPUQueue;!e||!e.prototype||zu(e.prototype,`copyElementImageToTexture`,{configurable:!0,writable:!0,value:Du})}function Du(...e){let t,n,r,i;if(e.length===2)[t,n]=e,r=0,i=0;else if(e.length===4)[t,r,i,n]=e;else throw TypeError(`copyElementImageToTexture: expected 2 or 4 args, got ${e.length}`);if(!(t instanceof HTMLElement))throw TypeError(`copyElementImageToTexture: source must be an HTMLElement`);let a=du.getCanvas(t);if(!a)throw new DOMException("copyElementImageToTexture: no snapshot recorded yet for this element. Call from inside the canvas `onpaint` handler or after at least one `requestPaint()` + rAF cycle.",`InvalidStateError`);r===0&&(r=a.width),i===0&&(i=a.height);let o=a;if(a.width!==r||a.height!==i){o=ku(r,i);let e=o.getContext(`2d`);e.clearRect(0,0,r,i),e.imageSmoothingEnabled=!0,e.imageSmoothingQuality=`high`,e.drawImage(a,0,0,r,i)}this.copyExternalImageToTexture({source:o},n,[r,i])}var Ou=null;function ku(e,t){return Ou||=document.createElement(`canvas`),Ou.width!==e&&(Ou.width=e),Ou.height!==t&&(Ou.height=t),Ou}function Au(e,t){let n=this;bu(n,e);let r=du.getCssSize(e);if(!r)throw new DOMException(`no snapshot recorded yet`,`InvalidStateError`);return xu(e,t,n.width/Math.max(1,n.clientWidth),n.height/Math.max(1,n.clientHeight),r.width,r.height)}function ju(){zu(HTMLCanvasElement.prototype,`layoutSubtree`,{configurable:!0,get(){return this.hasAttribute(`layoutsubtree`)},set(e){e?this.setAttribute(`layoutsubtree`,``):this.removeAttribute(`layoutsubtree`)}}),zu(HTMLCanvasElement.prototype,`onpaint`,{configurable:!0,get(){return uu.get(this)?.onpaint??null},set(e){let t=Uu(this);t?t.onpaint=e:e&&console.warn("[html-in-canvas polyfill] setting onpaint on a canvas without `layoutsubtree` — the handler will never fire. Add the `layoutsubtree` attribute first.")}}),zu(HTMLCanvasElement.prototype,`requestPaint`,{configurable:!0,writable:!0,value:function(){let e=Uu(this);if(e){for(let t of e.children)e.dirty.add(t);Qu(e,`requestPaint`)}}}),zu(HTMLCanvasElement.prototype,`getElementTransform`,{configurable:!0,writable:!0,value:Au}),zu(HTMLCanvasElement.prototype,`captureElementImage`,{configurable:!0,writable:!0,value:function(e){bu(this,e);let t=du.getCanvas(e);if(!t)throw new DOMException(`no snapshot recorded yet`,`InvalidStateError`);return t}}),Mu(`children`,e=>e.children),Mu(`firstElementChild`,e=>e.firstElementChild),Mu(`lastElementChild`,e=>e.lastElementChild),Mu(`childElementCount`,e=>e.childElementCount),Fu(),Iu(),Ru()}function Mu(e,t){let n=Object.getOwnPropertyDescriptor(Element.prototype,e);zu(HTMLCanvasElement.prototype,e,{configurable:!0,get(){let e=uu.get(this);return e&&this.hasAttribute(`layoutsubtree`)?t(e.host):n.get.call(this)}})}function Nu(e,t,n){e.children.has(t)||(n?e.host.insertBefore(t,n):e.host.appendChild(t),t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.opacity=`0`,t.style.pointerEvents=`auto`,e.children.add(t),e.dirty.add(t),gu.set(t,e.canvas),Qu(e,`addChildToState`))}function Pu(e,t){return e.children.has(t)?(e.host.removeChild(t),e.children.delete(t),e.dirty.delete(t),gu.delete(t),t.style.removeProperty(`position`),t.style.removeProperty(`left`),t.style.removeProperty(`top`),t.style.removeProperty(`opacity`),t.style.removeProperty(`pointer-events`),t.style.removeProperty(`transform-origin`),!0):!1}function Fu(){let e=Node.prototype.appendChild;zu(HTMLCanvasElement.prototype,`appendChild`,{configurable:!0,writable:!0,value:function(t){let n=uu.get(this);return n&&this.hasAttribute(`layoutsubtree`)&&t instanceof HTMLElement?(Nu(n,t),t):e.call(this,t)}});let t=Node.prototype.removeChild;zu(HTMLCanvasElement.prototype,`removeChild`,{configurable:!0,writable:!0,value:function(e){let n=uu.get(this);return n&&e instanceof HTMLElement&&Pu(n,e)?e:t.call(this,e)}});let n=Node.prototype.insertBefore;zu(HTMLCanvasElement.prototype,`insertBefore`,{configurable:!0,writable:!0,value:function(e,t){let r=uu.get(this);return r&&this.hasAttribute(`layoutsubtree`)&&e instanceof HTMLElement?(Nu(r,e,t),e):n.call(this,e,t)}}),zu(HTMLCanvasElement.prototype,`contains`,{configurable:!0,writable:!0,value:function(e){let t=uu.get(this);return t&&e&&t.host.contains(e)?!0:Node.prototype.contains.call(this,e)}})}function Iu(){for(let e of[`parentNode`,`parentElement`]){let t=Object.getOwnPropertyDescriptor(Node.prototype,e);zu(Node.prototype,e,{configurable:!0,get(){return gu.get(this)??t.get.call(this)}})}}var Lu=new Set([`mousemove`,`mousedown`,`mouseup`,`mouseenter`,`mouseleave`,`mouseover`,`mouseout`,`click`,`dblclick`,`contextmenu`,`wheel`,`pointerdown`,`pointerup`,`pointermove`,`pointerenter`,`pointerleave`,`pointerover`,`pointerout`]);function Ru(){let e=EventTarget.prototype.addEventListener,t=EventTarget.prototype.removeEventListener,n=new WeakMap;zu(HTMLCanvasElement.prototype,`addEventListener`,{configurable:!0,writable:!0,value:function(t,r,i){e.call(this,t,r,i);let a=uu.get(this);if(a&&Lu.has(t)&&r){let o=typeof r==`function`?r.bind(this):r;n.set(r,o),e.call(a.host,t,o,i)}}}),zu(HTMLCanvasElement.prototype,`removeEventListener`,{configurable:!0,writable:!0,value:function(e,r,i){t.call(this,e,r,i);let a=uu.get(this);if(a&&Lu.has(e)&&r){let o=n.get(r);o&&(t.call(a.host,e,o,i),n.delete(r))}}})}function zu(e,t,n){mu.push([e,t,Object.getOwnPropertyDescriptor(e,t)]),Object.defineProperty(e,t,n)}function Bu(){let e=()=>{for(let e of uu.values())e.positionHost()};Vu(window,`scroll`,e,{passive:!0}),Vu(window,`resize`,e)}function Vu(e,t,n,r){e.addEventListener(t,n,r),hu.push([e,t,n,r])}function Hu(){let e=()=>{fu&&document.querySelectorAll(`canvas[layoutsubtree]`).forEach(Uu)};document.readyState===`loading`?Vu(document,`DOMContentLoaded`,e,{once:!0}):e(),_u=new MutationObserver(e=>{for(let t of e)if(t.type===`attributes`&&t.attributeName===`layoutsubtree`){let e=t.target;if(!(e instanceof HTMLCanvasElement))continue;if(e.hasAttribute(`layoutsubtree`))Uu(e);else{let t=uu.get(e);t&&(Xu(t),uu.delete(e))}}else if(t.type===`childList`)for(let e of Array.from(t.addedNodes))e instanceof HTMLCanvasElement&&e.hasAttribute(`layoutsubtree`)?Uu(e):e instanceof Element&&e.querySelectorAll(`canvas[layoutsubtree]`).forEach(Uu)}),_u.observe(document.documentElement,{attributes:!0,subtree:!0,attributeFilter:[`layoutsubtree`],childList:!0})}function Uu(e){let t=uu.get(e);if(t)return t;if(!e.hasAttribute(`layoutsubtree`))return null;let n=Wu(e),r=new Set,i=new Set,a=[],o=()=>{let t=e.getBoundingClientRect();n.style.left=t.left+window.scrollX+e.clientLeft+`px`,n.style.top=t.top+window.scrollY+e.clientTop+`px`,n.style.width=e.clientWidth+`px`,n.style.height=e.clientHeight+`px`},s={canvas:e,host:n,children:r,dirty:i,onpaint:null,rafHandle:0,caretBlinkInterval:null,positionHost:o,observers:a,cleanups:[]};return Gu(n,s),uu.set(e,s),Ju(s),o(),Yu(s),s}function Wu(e){let t=document.createElement(`div`);return t.setAttribute(`data-html-in-canvas-host`,``),e.className&&(t.className=e.className),e.id&&t.setAttribute(`data-host-of`,e.id),t.style.cssText=`position:absolute;left:0;top:0;margin:0;padding:0;pointer-events:auto;transform-style:preserve-3d;`,document.body.appendChild(t),t}function Gu(e,t){let n=(e=`hostListener`)=>{for(let e of t.children)t.dirty.add(e);Qu(t,e)};e.addEventListener(`load`,e=>{e.target instanceof HTMLImageElement&&n(`image-load`)},!0),e.addEventListener(`input`,()=>n(`input`),!0),e.addEventListener(`change`,()=>n(`change`),!0);let r=()=>{let t=window.getSelection(),r=t&&!t.isCollapsed&&t.rangeCount>0&&e.contains(t.getRangeAt(0).startContainer);(e.contains(document.activeElement)||r)&&n(`selectionchange`)};document.addEventListener(`selectionchange`,r),t.cleanups.push(()=>document.removeEventListener(`selectionchange`,r)),e.addEventListener(`mouseover`,t=>{let n=t.target;if(n.classList){n.classList.add(`pseudo-hover`);for(let t of Ku(n,e))t.classList.add(`pseudo-hover`)}},!0),e.addEventListener(`mouseout`,e=>{let t=e.target;if(t.classList){t.classList.remove(`pseudo-hover`);for(let e of t.querySelectorAll(`.pseudo-hover`))e.classList.remove(`pseudo-hover`)}},!0),e.addEventListener(`focusin`,r=>{let i=r.target;if(i.classList){i.classList.add(`pseudo-focus`);for(let t of Ku(i,e))t.classList.add(`pseudo-focus-within`);try{i.matches(`:focus-visible`)&&i.classList.add(`pseudo-focus-visible`)}catch{}(i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement)&&(t.caretBlinkInterval&&clearInterval(t.caretBlinkInterval),t.caretBlinkInterval=setInterval(()=>n(`caret-blink`),500))}},!0),e.addEventListener(`focusout`,r=>{let i=r.target;i.classList&&i.classList.remove(`pseudo-focus`,`pseudo-focus-visible`);for(let t of e.querySelectorAll(`.pseudo-focus-within`))t.classList.remove(`pseudo-focus-within`);t.caretBlinkInterval&&(clearInterval(t.caretBlinkInterval),t.caretBlinkInterval=null,n(`caret-remove`))},!0),e.addEventListener(`pointerdown`,t=>{let n=t.target;if(n.classList){n.classList.add(`pseudo-active`);for(let t of Ku(n,e))t.classList.add(`pseudo-active`)}},!0);let i=()=>{for(let t of e.querySelectorAll(`.pseudo-active`))t.classList.remove(`pseudo-active`)};e.addEventListener(`pointerup`,i,!0),e.addEventListener(`pointercancel`,i,!0)}function Ku(e,t){let n=[],r=e.parentElement;for(;r&&r!==t;)n.push(r),r=r.parentElement;return n}var qu=Object.getOwnPropertyDescriptor(Element.prototype,`children`).get;function Ju(e){for(let t of Array.from(qu.call(e.canvas)))Nu(e,t)}function Yu(e){let t=new ResizeObserver(()=>{e.positionHost();for(let t of e.children)e.dirty.add(t);Qu(e,`ResizeObserver`)});t.observe(e.canvas),e.observers.push(t);let n=new MutationObserver(t=>{let n=!1;for(let r of t){let t=r.target;for(;t&&!(t instanceof HTMLElement&&e.children.has(t));)t=t.parentNode;t&&(e.dirty.add(t),n=!0)}n&&Qu(e,`MutationObserver`)});n.observe(e.host,{childList:!0,subtree:!0,attributes:!0,characterData:!0}),e.observers.push(n)}function Xu(e){e.rafHandle&&=(cancelAnimationFrame(e.rafHandle),0),e.caretBlinkInterval&&=(clearInterval(e.caretBlinkInterval),null);for(let t of e.cleanups)t();e.cleanups.length=0;for(let t of e.observers)t.disconnect();e.observers.length=0,e.dirty.clear(),e.onpaint=null;let t=[`pseudo-hover`,`pseudo-focus`,`pseudo-focus-visible`,`pseudo-focus-within`,`pseudo-active`];for(let n of Array.from(e.children)){n.classList.remove(...t);for(let e of n.querySelectorAll(`.pseudo-hover, .pseudo-focus, .pseudo-focus-visible, .pseudo-focus-within, .pseudo-active`))e.classList.remove(...t);Pu(e,n),Node.prototype.appendChild.call(e.canvas,n)}e.host.remove()}var Zu=typeof location<`u`&&new URLSearchParams(location.search).has(`debugPolyfillHIC`);function Qu(e,t){Zu&&t&&console.trace(`[html-in-canvas debug] schedulePaint from:`,t),!e.rafHandle&&(e.rafHandle=requestAnimationFrame(async()=>{var t;if(e.rafHandle=0,!uu.has(e.canvas))return;e.positionHost();let n=Array.from(e.dirty);if(e.dirty.clear(),n.length&&await Promise.all(n.map($u)),!uu.has(e.canvas))return;let r=new Event(`paint`);r.changedElements=n;try{(t=e.onpaint)==null||t.call(e.canvas,r)}catch(e){console.error(`[html-in-canvas polyfill] onpaint threw`,e)}e.canvas.dispatchEvent(r)}))}async function $u(e){try{await du.update(e)}catch(t){console.error(`[html-in-canvas polyfill] rasterize failed for ${ed(e)}:`,t instanceof Error?t.message+`
`+t.stack:t)}}function ed(e){let t=e.tagName.toLowerCase(),n=e.id?`#${e.id}`:``,r=e.getAttribute(`class`)||``;return`<${t}${n}${r?`.${r.trim().replace(/\s+/g,`.`)}`:``}>`}function td(){if(!window.__HTML_IN_CANVAS_POLYFILL__)return;let e=[globalThis.WebGLRenderingContext,globalThis.WebGL2RenderingContext];for(let t of e){if(!t)continue;let e=t.prototype,n=e.texElementImage2D;!n||n.length!==3||Object.defineProperty(e,"texElementImage2D",{configurable:!0,writable:!0,value:function(e,t,r,i,a,o){n.call(this,e,t,r,i,a,o)}})}}var nd=e({MoriaLightCanvas:()=>od}),rd=new J(0,-1,0),id=new J(0,1,0),ad=rd.clone();function od({onReady:e,onError:t}){let n=(0,i.useRef)(window.matchMedia(`(max-width: 700px)`).matches).current,r=(0,i.useRef)(null),s=(0,i.useRef)(null),c=(0,i.useRef)(null),u=(0,i.useRef)(new Z),p=(0,i.useRef)(null),[m,h]=(0,i.useState)(o),g=(0,i.useRef)(m),[_,v]=(0,i.useState)(!1),[b,x]=(0,i.useState)(!1),[S,C]=(0,i.useState)(``);return(0,i.useEffect)(()=>{let e=!0;if(n)return queueMicrotask(()=>{e&&v(!0)}),()=>{e=!1};r.current?.setAttribute(`layoutsubtree`,``);try{vu();let t=window.devicePixelRatio||1;pu().pixelRatio=window.innerWidth<760?Pt.clamp(t,1,1.25):Math.max(3,t),td(),queueMicrotask(()=>{e&&v(!0)})}catch(n){console.error(`HTML-in-Canvas could not be initialized.`,n),queueMicrotask(()=>{e&&(C(`HTML-in-Canvas is not available in this browser.`),t?.())})}return()=>{e=!1}},[t,n]),(0,i.useEffect)(()=>{if(!_)return;let i=r.current,l=s.current;if(!i||!l)return;let u=!1,d=0,f=0,m=0,v=performance.now(),b=0,S=0,w=!1,T=-1,E=0,D=0,O=-1,k=0,A=0,ee=o.angle,te=!1,j=1/120,M=1.22,N=1,ne=new J(0,-9.81,0),P=new J(0,4.72,1.18),F=new J(.16,P.y-M,P.z+.08),re=F.clone().add(new J(.018,0,-.012)),ie=new J(0,.3,.08),ae=new J,I=ie.clone(),oe=new J,L=new J,se=new J,ce=new J,le=new J,ue=new J,de=ad.clone(),fe=new J,pe=new Ft,me=new Ft,he=new Ft,ge=new q,_e=new J,ve=new ki(new J(0,0,1),-.08),ye=new oo,be;try{be=new Dl({canvas:i,antialias:!0,alpha:!0,powerPreference:`high-performance`})}catch(e){console.error(e);let n=window.setTimeout(()=>{u||(C(`This experience needs WebGL to render the Moria light study.`),t?.())},0);return()=>{u=!0,window.clearTimeout(n)}}be.outputColorSpace=Ke,be.toneMapping=7,be.toneMappingExposure=1.08,be.setClearColor(66052,+!n);let xe=new Bn;xe.background=n?null:new Z(66052);let Se=new Fa(37,1,.1,80);Se.position.set(0,.2,13.6);let Ce=new Mn;Ce.position.set(0,-.35,0),xe.add(Ce);let we=document.createElement(`canvas`);we.width=1,we.height=1;let Te=n?new Fi(we):new Ii(l);Te.colorSpace=Ke,Te.minFilter=y,Te.magFilter=y,Te.generateMipmaps=!1;let Ee=new Wi(1,1,1,1),De=new ra({map:Te,color:12962516,roughness:.96,metalness:0,transparent:!0,alphaTest:.005,side:0}),Oe=new Si(Ee,De);Oe.visible=!n,Ce.add(Oe);let ke=new ra({color:526864,roughness:.9,metalness:.03}),Ae=new Si(new Wi(1.018,1.028),ke);Ae.position.z=-.035,Ae.visible=!n,Ce.add(Ae);let R=new Ca(7438491,1380632,.58);xe.add(R);let je=new Ha(9545416,.24);je.position.set(-4.8,5.6,7.4),xe.add(je);let z=new Mn;xe.add(z);let Me=new Si(new Hi(.24,.3,.11,24),new ra({color:1053208,roughness:.64,metalness:.7}));Me.position.copy(P).add(new J(0,.08,0)),xe.add(Me);let B=new Si(new Hi(.014,.014,1,10),new ra({color:1184536,roughness:.5,metalness:.55}));xe.add(B);let Ne=new Mn;z.add(Ne);let V=[new q(.08,.08),new q(.18,.02),new q(.43,-.1),new q(.82,-.25),new q(1.08,-.36),new q(1.1,-.41)],H=new ra({color:1052950,roughness:.36,metalness:.74,side:2}),Pe=new Si(new Ui(V,48),H);Ne.add(Pe);let Fe=new Si(new Ki(1.095,.027,8,48),new ra({color:1513759,roughness:.28,metalness:.82}));Fe.rotation.x=Math.PI/2,Fe.position.y=-.397,Ne.add(Fe);let Ie=new ra({color:new Z(o.color).multiplyScalar(.18),emissive:o.color,emissiveIntensity:.42,roughness:.92,side:2}),Le=new Si(new Vi(1.055,48),Ie);Le.rotation.x=Math.PI/2,Le.position.y=-.385,Ne.add(Le);let Re=new Si(new Hi(.095,.12,.2,20),new ra({color:10250052,roughness:.44,metalness:.66}));Re.position.y=.08,Ne.add(Re);let ze=new ra({color:16766893,emissive:o.color,emissiveIntensity:3.2,roughness:.2}),Be=new Si(new Gi(.16,20,12),ze);Be.scale.y=1.2,Be.position.y=-.33,Ne.add(Be);let Ve=Je(),He=new Br({map:Ve,color:o.color,transparent:!0,opacity:.86,depthWrite:!1,blending:2}),Ue=new ei(He);Ue.position.y=-.36,Ue.scale.set(.96,.96,.96),Ne.add(Ue);let We=new La(o.color,1,18,Pt.degToRad(o.angle),.88,2);We.power=o.brightness,We.position.set(0,-.35,0),We.target.position.set(0,-7,0),Ne.add(We,We.target);let Ge=new za(o.color,1,3.2,2);Ge.power=36,Ge.position.set(0,-.35,0),Ne.add(Ge),c.current={spot:We,bulbLight:Ge,bulbMaterial:ze,glowMaterial:He,undersideMaterial:Ie};let qe=new Ml;qe.connect(be,Se),n||qe.add(Oe);function Je(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);if(t){let e=t.createRadialGradient(32,32,0,32,32,32);e.addColorStop(0,`rgba(255,255,255,1)`),e.addColorStop(.16,`rgba(255,222,172,.8)`),e.addColorStop(.46,`rgba(255,170,94,.22)`),e.addColorStop(1,`rgba(255,140,70,0)`),t.fillStyle=e,t.fillRect(0,0,64,64)}let n=new Fi(e);return n.colorSpace=Ke,n}function Ye(){let e=Math.max(1,i.clientWidth),t=Math.max(1,i.clientHeight),n=Math.min(window.devicePixelRatio||1,e<760?1.5:2);be.setPixelRatio(n),be.setSize(e,t,!1),Se.aspect=e/t,Se.updateProjectionMatrix();let r=l.offsetWidth||e,a=l.offsetHeight||t,o=t>e*1.16,s=o?7.2:12.8,c=a/r*s;Oe.scale.set(s,c,1),Ae.scale.set(s,c,1);let u=o?Pt.clamp(e*.3,110,200):Pt.clamp(Math.min(e*.17,t*.34),140,280),d=s/e,f=c/t;N=u*d/2.2,z.scale.setScalar(N),Me.scale.setScalar(N),M=Pt.clamp(t*(o?.13:.16),o?72:80,150)*f,Ce.position.y=0;let p=o?18:12;if(P.set(0,c/2-p*f,o?1.1:1.18),Me.position.copy(P),Me.position.y+=.08*N,!w){let e=oe.copy(F).sub(P);e.lengthSq()<.001&&e.copy(rd),e.normalize().multiplyScalar(M),F.copy(P).add(e),re.copy(F)}let m=Pt.degToRad(Se.fov*.5),h=c/(2*Math.tan(m));Se.position.set(0,0,h),Se.lookAt(0,0,0),Se.updateMatrixWorld(),qe.update(),i.requestPaint?.(),$e()}function Xe(){le.copy(F).sub(P).normalize(),fe.copy(P).add(F).multiplyScalar(.5),B.position.copy(fe),B.scale.set(N,M,N),he.setFromUnitVectors(id,le),B.quaternion.copy(he),w?(ue.copy(ie).sub(F).normalize(),de.lerp(ue,.32).normalize()):(pe.setFromUnitVectors(rd,le),ue.copy(ad).applyQuaternion(pe).normalize(),de.lerp(ue,.14).normalize()),me.setFromUnitVectors(rd,de),z.position.copy(F),z.quaternion.copy(me)}function Ze(){ce.copy(F).sub(re).multiplyScalar(w?.985:.9948),re.copy(F),F.add(ce).addScaledVector(ne,j*j),w&&(L.copy(ie).sub(P).normalize(),L.lerp(rd,1-D*.82).normalize(),se.copy(L).multiplyScalar(M).add(P).sub(F),oe.copy(F).sub(P).normalize(),se.addScaledVector(oe,-se.dot(oe)),F.addScaledVector(se,52*j*j)),oe.copy(F).sub(P),oe.lengthSq()<1e-8&&oe.copy(rd),oe.normalize().multiplyScalar(M),F.copy(P).add(oe),ce.copy(F).sub(re),w?S=0:ce.lengthSq()<14e-9?S+=1:S=0}function Qe(e){if(f=0,u)return;let t=Math.min((e-v)/1e3,.05);for(v=e,b=Math.min(b+t,j*5);b>=j;)Ze(),b-=j;Xe(),qe.update(),be.render(xe,Se),d+=1,(w||S<80||d<4)&&(f=requestAnimationFrame(Qe))}function $e(){S=0,!f&&!u&&(v=performance.now(),f=requestAnimationFrame(Qe))}p.current=$e;function et(e){let t=i.getBoundingClientRect();ge.x=(e.clientX-t.left)/t.width*2-1,ge.y=-((e.clientY-t.top)/t.height)*2+1,ye.setFromCamera(ge,Se)}function tt(e){if(et(e),!ye.ray.intersectPlane(ve,ie))return!1;_e.copy(F).project(Se);let t=(ge.x-_e.x)*Se.aspect,n=ge.y-_e.y,r=Math.sqrt(t*t+n*n);return D=Pt.smoothstep(r,.08,1.15),!0}function nt(e){if(e.button===2){O=e.pointerId,k=e.clientX,A=e.clientY,ee=g.current.angle,te=!1,l.classList.add(`is-adjusting-beam`);return}e.button!==0||O!==-1||tt(e)&&(w=!0,T=e.pointerId,E=performance.now(),I.copy(ie),ae.set(0,0,0),i.classList.add(`is-pulling-light`),$e())}function rt(e){if(e.pointerId===O){let t=e.clientX-k,n=e.clientY-A;if(!te&&Math.hypot(t,n)>=4&&(te=!0),te){let e=Pt.clamp(Math.round(ee+t*.14),16,60);h(t=>t.angle===e?t:{...t,angle:e}),$e()}return}if(!w||e.pointerId!==T||!tt(e))return;let t=performance.now(),n=Math.max(.008,Math.min(.05,(t-E)/1e3));oe.copy(ie).sub(I).multiplyScalar(1/n),ae.lerp(oe,.34),I.copy(ie),E=t,$e()}function it(e){if(e.pointerId===O){let t=!te&&e.type!==`pointercancel`;O=-1,te=!1,l.classList.remove(`is-adjusting-beam`),t&&h(e=>{let t=a[(a.findIndex(t=>t===e.color.toLowerCase())+1)%a.length];return{...e,color:t}}),$e();return}if(!w||e.pointerId!==T)return;ce.copy(F).sub(re).multiplyScalar(1/j),oe.copy(F).sub(P).normalize(),ae.addScaledVector(oe,-ae.dot(oe)).clampLength(0,6);let t=Pt.lerp(.055,.12,D);if(ce.addScaledVector(ae,t),L.copy(P).addScaledVector(rd,M).sub(F),L.addScaledVector(oe,-L.dot(oe)),L.lengthSq()>1e-4){L.normalize();let e=Pt.lerp(.32,1.6,D);ce.addScaledVector(L,e)}ce.clampLength(0,4.25),re.copy(F).addScaledVector(ce,-.008333333333333333),w=!1,T=-1,D=0,i.classList.remove(`is-pulling-light`),$e()}function at(){w=!1,T=-1,D=0,F.copy(P).addScaledVector(rd,M),re.copy(F),ae.set(0,0,0),de.copy(ad),i.classList.remove(`is-pulling-light`),O=-1,te=!1,l.classList.remove(`is-adjusting-beam`),$e()}function U(){cancelAnimationFrame(m),m=requestAnimationFrame(Ye)}let W=!1,ot=!1,st=0,ct=0;function lt(e){u||ot||(window.clearTimeout(ct),console.error(`Interactive light initialization failed.`,e),C(`The interactive light could not be initialized in this browser.`),t?.())}function ut(){if(!W)try{W=!0,Ye(),Xe(),qe.update(),be.render(xe,Se),d+=1}catch(e){lt(e)}}function dt(){if(W){if(ot){$e();return}cancelAnimationFrame(st),st=requestAnimationFrame(()=>{try{Xe(),qe.update(),Te.needsUpdate=!0,be.render(xe,Se),d+=1,ot=!0,window.clearTimeout(ct),C(``),x(!0),e?.(),$e()}catch(e){lt(e)}})}}function ft(e){e.preventDefault()}return i.addEventListener(`pointerdown`,nt),i.addEventListener(`dblclick`,at),i.addEventListener(`contextmenu`,ft),window.addEventListener(`pointermove`,rt,{passive:!0}),window.addEventListener(`pointerup`,it),window.addEventListener(`pointercancel`,it),window.addEventListener(`resize`,U,{passive:!0}),n?(W=!0,dt()):(i.addEventListener(`paint`,dt),i.onpaint=ut,document.fonts.ready.then(()=>{u||(ct=window.setTimeout(()=>{lt(Error(`Timed out while preparing the interactive HTML surface.`))},3e4),i.requestPaint?i.requestPaint():ut())}).catch(lt)),()=>{u=!0,cancelAnimationFrame(f),cancelAnimationFrame(m),i.removeEventListener(`pointerdown`,nt),i.removeEventListener(`dblclick`,at),i.removeEventListener(`contextmenu`,ft),window.removeEventListener(`pointermove`,rt),window.removeEventListener(`pointerup`,it),window.removeEventListener(`pointercancel`,it),window.removeEventListener(`resize`,U),cancelAnimationFrame(st),window.clearTimeout(ct),i.removeEventListener(`paint`,dt),i.onpaint=null,qe.disconnect(),p.current=null,c.current=null,Te.dispose(),Ee.dispose(),De.dispose(),Ae.geometry.dispose(),ke.dispose(),Pe.geometry.dispose(),H.dispose(),Fe.geometry.dispose(),Fe.material.dispose(),Le.geometry.dispose(),Ie.dispose(),Re.geometry.dispose(),Re.material.dispose(),Be.geometry.dispose(),ze.dispose(),B.geometry.dispose(),B.material.dispose(),Me.geometry.dispose(),Me.material.dispose(),Ve.dispose(),He.dispose(),be.dispose()}},[_,t,e,n]),(0,i.useEffect)(()=>{g.current=m;let e=c.current;if(!e)return;let t=u.current.set(m.color),n=m.enabled?m.brightness:0;e.spot.color.copy(t),e.spot.power=n,e.spot.angle=Pt.degToRad(m.angle),e.bulbLight.color.copy(t),e.bulbLight.power=m.enabled?Math.max(18,m.brightness*.026):0,e.bulbMaterial.emissive.copy(t),e.bulbMaterial.emissiveIntensity=m.enabled?2.4+m.brightness/850:.04,e.glowMaterial.color.copy(t),e.glowMaterial.opacity=m.enabled?.52+m.brightness/4200:0,e.undersideMaterial.color.copy(t).multiplyScalar(.18),e.undersideMaterial.emissive.copy(t),e.undersideMaterial.emissiveIntensity=m.enabled?.22+m.brightness/7250:.03,r.current?.requestPaint?.(),p.current?.()},[m]),(0,l.jsxs)(`main`,{className:`experience-shell${b?` is-ready`:``}`,"aria-label":`Interactive Moria light study`,"aria-busy":!b&&!S,children:[n?(0,l.jsx)(`div`,{className:`mobile-page-surface`,children:(0,l.jsx)(d,{sourceRef:s,lighting:m})}):null,(0,l.jsx)(`canvas`,{ref:r,className:`webgl-canvas`,"aria-label":`Interactive Moria light study`,children:n?null:(0,l.jsx)(d,{sourceRef:s,lighting:m})}),n?null:(0,l.jsx)(f,{hidden:b}),(0,l.jsxs)(`div`,{className:`scene-status${b||S?` is-hidden`:``}`,"aria-live":`polite`,children:[(0,l.jsx)(`span`,{}),` PREPARING HTML SURFACE`]}),S?(0,l.jsx)(`div`,{className:`scene-error`,children:S}):null]})}export{r as a,o as i,d as n,c as r,nd as t};