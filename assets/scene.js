...
`+t.stack:t)}}function ed(e){let t=e.tagName.toLowerCase(),n=e.id?`#${e.id}`:``,r=e.getAttribute(`class`)||``;return`<${t}${n}${r?`.${r.trim().replace(/\s+/g,`.`)}`:``}>`}function td(){if(!window.__HTML_IN_CANVAS_POLYFILL__)return;let e=[globalThis.WebGLRenderingContext,globalThis.WebGL2RenderingContext];for(let t of e){if(!t)continue;let e=t.prototype,n=e.texElementImage2D;!n||n.length!==3||Object.defineProperty(e,"texElementImage2D",{configurable:!0,writable:!0,value:function(e,t,r,i,a,o){n.call(this,e,t,r,i,a,o)}})}}var nd=e({MoriaLightCanvas:()=>od}),rd=new J(0,-1,0),id=new J(0,1,0),ad=rd.clone();function od({onReady:e}){let t=(0,i.useRef)(null),n=(0,i.useRef)(null),r=(0,i.useRef)(null),s=(0,i.useRef)(new Z),c=(0,i.useRef)(null),[u,p]=(0,i.useState)(o),m=(0,i.useRef)(u),[h,g]=(0,i.useState)(!1),[_,v]=(0,i.useState)(!1),[b,x]=(0,i.useState)(``);return(0,i.useEffect)(()=>{let e=!0;t.current?.setAttribute(`layoutsubtree`,``);try{vu();let t=window.innerWidth<760?2.5:3;pu().pixelRatio=Math.max(t,window.devicePixelRatio||1),td(),queueMicrotask(()=>{e&&g(!0)})}catch(t){console.error(`HTML-in-Canvas could not be initialized.`,t),queueMicrotask(()=>{e&&x(`HTML-in-Canvas is not available in this browser.`)})}return()=>{e=!1}},[]),(0,i.useEffect)(()=>{if(!h)return;let i=t.current,s=n.current;if(!i||!s)return;let l=!1,u=0,d=0,f=0,g=performance.now(),_=0,b=0,S=!1,C=-1,w=0,T=0,E=-1,D=0,O=0,k=o.angle,A=!1,j=1/120,ee=1.22,M=1,te=new J(0,-9.81,0),N=new J(0,4.72,1.18),P=new J(.16,N.y-ee,N.z+.08),ne=P.clone().add(new J(.018,0,-.012)),re=new J(0,.3,.08),ie=new J,ae=re.clone(),F=new J,I=new J,oe=new J,L=new J,se=new J,ce=new J,le=ad.clone(),ue=new J,de=new Ft,fe=new Ft,pe=new Ft,me=new q,he=new J,ge=new ki(new J(0,0,1),-.08),_e=new oo,ve;try{ve=new Dl({canvas:i,antialias:!0,alpha:!0,powerPreference:`high-performance`})}catch(e){console.error(e);let t=window.setTimeout(()=>{l||x(`This experience needs WebGL to render the Moria light study.`)},0);return()=>{l=!0,window.clearTimeout(t)}}ve.outputColorSpace=Ke,ve.toneMapping=7,ve.toneMappingExposure=1.08,ve.setClearColor(66052,1);let ye=new Bn;ye.background=new Z(66052);let be=new Fa(37,1,.1,80);be.position.set(0,.2,13.6);let xe=new Mn;xe.position.set(0,-.35,0),ye.add(xe);let Se=new Ii(s);Se.colorSpace=Ke,Se.minFilter=y,Se.magFilter=y,Se.generateMipmaps=!1;let Ce=new Wi(1,1,1,1),we=new ra({map:Se,color:12962516,roughness:.96,metalness:0,transparent:!0,alphaTest:.005,side:0}),Te=new Si(Ce,we);xe.add(Te);let Ee=new ra({color:526864,roughness:.9,metalness:.03}),De=new Si(new Wi(1.018,1.028),Ee);De.position.z=-.035,xe.add(De);let Oe=new Ca(7438491,1380632,.58);ye.add(Oe);let ke=new Ha(9545416,.24);ke.position.set(-4.8,5.6,7.4),ye.add(ke);let Ae=new Mn;ye.add(Ae);let R=new Si(new Hi(.24,.3,.11,24),new ra({color:1053208,roughness:.64,metalness:.7}));R.position.copy(N).add(new J(0,.08,0)),ye.add(R);let je=new Si(new Hi(.014,.014,1,10),new ra({color:1184536,roughness:.5,metalness:.55}));ye.add(je);let z=new Mn;Ae.add(z);let Me=[new q(.08,.08),new q(.18,.02),new q(.43,-.1),new q(.82,-.25),new q(1.08,-.36),new q(1.1,-.41)],B=new ra({color:1052950,roughness:.36,metalness:.74,side:2}),Ne=new Si(new Ui(Me,48),B);z.add(Ne);let V=new Si(new Ki(1.095,.027,8,48),new ra({color:1513759,roughness:.28,metalness:.82}));V.rotation.x=Math.PI/2,V.position.y=-.397,z.add(V);let H=new ra({color:new Z(o.color).multiplyScalar(.18),emissive:o.color,emissiveIntensity:.42,roughness:.92,side:2}),Pe=new Si(new Vi(1.055,48),H);Pe.rotation.x=Math.PI/2,Pe.position.y=-.385,z.add(Pe);let Fe=new Si(new Hi(.095,.12,.2,20),new ra({color:10250052,roughness:.44,metalness:.66}));Fe.position.y=.08,z.add(Fe);let Ie=new ra({color:16766893,emissive:o.color,emissiveIntensity:3.2,roughness:.2}),Le=new Si(new Gi(.16,20,12),Ie);Le.scale.y=1.2,Le.position.y=-.33,z.add(Le);let Re=We(),ze=new Br({map:Re,color:o.color,transparent:!0,opacity:.86,depthWrite:!1,blending:2}),Be=new ei(ze);Be.position.y=-.36,Be.scale.set(.96,.96,.96),z.add(Be);let Ve=new La(o.color,1,18,Pt.degToRad(o.angle),.88,2);Ve.power=o.brightness,Ve.position.set(0,-.35,0),Ve.target.position.set(0,-7,0),z.add(Ve,Ve.target);let He=new za(o.color,1,3.2,2);He.power=36,He.position.set(0,-.35,0),z.add(He),r.current={spot:Ve,bulbLight:He,bulbMaterial:Ie,glowMaterial:ze,undersideMaterial:H};let Ue=new Ml;Ue.connect(ve,be),Ue.add(Te);function We(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);if(t){let e=t.createRadialGradient(32,32,0,32,32,32);e.addColorStop(0,`rgba(255,255,255,1)`),e.addColorStop(.16,`rgba(255,222,172,.8)`),e.addColorStop(.46,`rgba(255,170,94,.22)`),e.addColorStop(1,`rgba(255,140,70,0)`),t.fillStyle=e,t.fillRect(0,0,64,64)}let n=new Fi(e);return n.colorSpace=Ke,n}function Ge(){let e=Math.max(1,i.clientWidth),t=Math.max(1,i.clientHeight),n=Math.min(window.devicePixelRatio||1,e<760?1.5:2);ve.setPixelRatio(n),ve.setSize(e,t,!1),be.aspect=e/t,be.updateProjectionMatrix();let r=s.offsetWidth||e,a=s.offsetHeight||t,o=t>e*1.16,c=o?7.2:12.8,l=a/r*c;Te.scale.set(c,l,1),De.scale.set(c,l,1);let u=o?Pt.clamp(e*.3,110,200):Pt.clamp(Math.min(e*.17,t*.34),140,280),d=c/e,f=l/t;M=u*d/2.2,Ae.scale.setScalar(M),R.scale.setScalar(M),ee=Pt.clamp(t*(o?.13:.16),o?72:80,150)*f,xe.position.y=0;let p=o?18:12;if(N.set(0,l/2-p*f,o?1.1:1.18),R.position.copy(N),R.position.y+=.08*M,!S){let e=F.copy(P).sub(N);e.lengthSq()<.001&&e.copy(rd),e.normalize().multiplyScalar(ee),P.copy(N).add(e),ne.copy(P)}let m=Pt.degToRad(be.fov*.5),h=l/(2*Math.tan(m));be.position.set(0,0,h),be.lookAt(0,0,0),be.updateMatrixWorld(),Ue.update(),i.requestPaint?.(),Xe()}function qe(){se.copy(P).sub(N).normalize(),ue.copy(N).add(P).multiplyScalar(.5),je.position.copy(ue),je.scale.set(M,ee,M),pe.setFromUnitVectors(id,se),je.quaternion.copy(pe),S?(ce.copy(re).sub(P).normalize(),le.lerp(ce,.32).normalize()):(de.setFromUnitVectors(rd,se),ce.copy(ad).applyQuaternion(de).normalize(),le.lerp(ce,.14).normalize()),fe.setFromUnitVectors(rd,le),Ae.position.copy(P),Ae.quaternion.copy(fe)}function Je(){L.copy(P).sub(ne).multiplyScalar(S?.985:.9948),ne.copy(P),P.add(L).addScaledVector(te,j*j),S&&(I.copy(re).sub(N).normalize(),I.lerp(rd,1-T*.82).normalize(),oe.copy(I).multiplyScalar(ee).add(N).sub(P),F.copy(P).sub(N).normalize(),oe.addScaledVector(F,-oe.dot(F)),P.addScaledVector(oe,52*j*j)),F.copy(P).sub(N),F.lengthSq()<1e-8&&F.copy(rd),F.normalize().multiplyScalar(ee),P.copy(N).add(F),L.copy(P).sub(ne),S?b=0:L.lengthSq()<14e-9?b+=1:b=0}function Ye(e){if(d=0,l)return;let t=Math.min((e-g)/1e3,.05);for(g=e,_=Math.min(_+t,j*5);_>=j;)Je(),_-=j;qe(),Ue.update(),ve.render(ye,be),u+=1,(S||b<80||u<4)&&(d=requestAnimationFrame(Ye))}function Xe(){b=0,!d&&!l&&(g=performance.now(),d=requestAnimationFrame(Ye))}c.current=Xe;function Ze(e){let t=i.getBoundingClientRect();me.x=(e.clientX-t.left)/t.width*2-1,me.y=-((e.clientY-t.top)/t.height)*2+1,_e.setFromCamera(me,be)}function Qe(e){if(Ze(e),!_e.ray.intersectPlane(ge,re))return!1;he.copy(P).project(be);let t=(me.x-he.x)*be.aspect,n=me.y-he.y,r=Math.sqrt(t*t+n*n);return T=Pt.smoothstep(r,.08,1.15),!0}function $e(e){if(e.button===2){E=e.pointerId,D=e.clientX,O=e.clientY,k=m.current.angle,A=!1,s.classList.add(`is-adjusting-beam`);return}e.button!==0||E!==-1||Qe(e)&&(S=!0,C=e.pointerId,w=performance.now(),ae.copy(re),ie.set(0,0,0),i.classList.add(`is-pulling-light`),Xe())}function et(e){if(e.pointerId===E){let t=e.clientX-D,n=e.clientY-O;if(!A&&Math.hypot(t,n)>=4&&(A=!0),A){let e=Pt.clamp(Math.round(k+t*.14),16,60);p(t=>t.angle===e?t:{...t,angle:e}),Xe()}return}if(!S||e.pointerId!==C||!Qe(e))return;let t=performance.now(),n=Math.max(.008,Math.min(.05,(t-w)/1e3));F.copy(re).sub(ae).multiplyScalar(1/n),ie.lerp(F,.34),ae.copy(re),w=t,Xe()}function tt(e){if(e.pointerId===E){let t=!A&&e.type!==`pointercancel`;E=-1,A=!1,s.classList.remove(`is-adjusting-beam`),t&&p(e=>{let t=a[(a.findIndex(t=>t===e.color.toLowerCase())+1)%a.length];return{...e,color:t}}),Xe();return}if(!S||e.pointerId!==C)return;L.copy(P).sub(ne).multiplyScalar(1/j),F.copy(P).sub(N).normalize(),ie.addScaledVector(F,-ie.dot(F)).clampLength(0,6);let t=Pt.lerp(.055,.12,T);if(L.addScaledVector(ie,t),I.copy(N).addScaledVector(rd,ee).sub(P),I.addScaledVector(F,-I.dot(F)),I.lengthSq()>1e-4){I.normalize();let e=Pt.lerp(.32,1.6,T);L.addScaledVector(I,e)}L.clampLength(0,4.25),ne.copy(P).addScaledVector(L,-.008333333333333333),S=!1,C=-1,T=0,i.classList.remove(`is-pulling-light`),Xe()}function nt(){S=!1,C=-1,T=0,P.copy(N).addScaledVector(rd,ee),ne.copy(P),ie.set(0,0,0),le.copy(ad),i.classList.remove(`is-pulling-light`),E=-1,A=!1,s.classList.remove(`is-adjusting-beam`),Xe()}function rt(){cancelAnimationFrame(f),f=requestAnimationFrame(Ge)}function it(){Xe()}function at(e){e.preventDefault()}return i.addEventListener(`pointerdown`,$e),i.addEventListener(`dblclick`,nt),i.addEventListener(`contextmenu`,at),window.addEventListener(`pointermove`,et,{passive:!0}),window.addEventListener(`pointerup`,tt),window.addEventListener(`pointercancel`,tt),window.addEventListener(`resize`,rt,{passive:!0}),i.addEventListener(`paint`,it),document.fonts.ready.then(()=>{l||(i.requestPaint?.(),Ge(),qe(),Ue.update(),ve.render(ye,be),u+=1,v(!0),e?.(),Xe())}),()=>{l=!0,cancelAnimationFrame(d),cancelAnimationFrame(f),i.removeEventListener(`pointerdown`,$e),i.removeEventListener(`dblclick`,nt),i.removeEventListener(`contextmenu`,at),window.removeEventListener(`pointermove`,et),window.removeEventListener(`pointerup`,tt),window.removeEventListener(`pointercancel`,tt),window.removeEventListener(`resize`,rt),i.removeEventListener(`paint`,it),Ue.disconnect(),c.current=null,r.current=null,Se.dispose(),Ce.dispose(),we.dispose(),De.geometry.dispose(),Ee.dispose(),Ne.geometry.dispose(),B.dispose(),V.geometry.dispose(),V.material.dispose(),Pe.geometry.dispose(),H.dispose(),Fe.geometry.dispose(),Fe.material.dispose(),Le.geometry.dispose(),Ie.dispose(),je.geometry.dispose(),je.material.dispose(),R.geometry.dispose(),R.material.dispose(),Re.dispose(),ze.dispose(),ve.dispose()}},[h,e]),(0,i.useEffect)(()=>{m.current=u;let e=r.current;if(!e)return;let n=s.current.set(u.color),i=u.enabled?u.brightness:0;e.spot.color.copy(n),e.spot.power=i,e.spot.angle=Pt.degToRad(u.angle),e.bulbLight.color.copy(n),e.bulbLight.power=u.enabled?Math.max(18,u.brightness*.026):0,e.bulbMaterial.emissive.copy(n),e.bulbMaterial.emissiveIntensity=u.enabled?2.4+u.brightness/850:.04,e.glowMaterial.color.copy(n),e.glowMaterial.opacity=u.enabled?.52+u.brightness/4200:0,e.undersideMaterial.color.copy(n).multiplyScalar(.18),e.undersideMaterial.emissive.copy(n),e.undersideMaterial.emissiveIntensity=u.enabled?.22+u.brightness/7250:.03,t.current?.requestPaint?.(),c.current?.()},[u]),(0,l.jsxs)(`main`,{className:`experience-shell${_?` is-ready`:``}`,"aria-label":`Interactive Moria light study`,"aria-busy":!_&&!b,children:[(0,l.jsx)(`canvas`,{ref:t,className:`webgl-canvas`,"aria-label":`Interactive Moria light study`,children:(0,l.jsx)(d,{sourceRef:n,lighting:u})}),(0,l.jsx)(f,{hidden:_||!!b}),(0,l.jsxs)(`div`,{className:`scene-status${_||b?` is-hidden`:``}`,"aria-live":`polite`,children:[(0,l.jsx)(`span`,{}),` PREPARING HTML SURFACE`]}),b?(0,l.jsx)(`div`,{className:`scene-error`,children:b}):null]})}export{r as a,o as i,d as n,c as r,nd as t};