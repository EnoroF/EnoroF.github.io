...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Go(e,t,n){let r=new Float32Array(jo),i=new J(0,1,0);return new sa({name:`SphericalGaussianBlur`,defines:{n:jo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Jo(),fragmentShader:`
	...
	`}var Yo=class extends sn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Bi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var bc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function xc(e,t){let n=bc[t];return n===void 0?(W(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Sc=new J;function Cc(){return X.getLuminanceCoefficients(Sc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Sc.x.toFixed(4)}, ${Sc.y.toFixed(4)}, ${Sc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=fc(i,i.VERTEX_SHADER,y),S=fc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=vc(i,x,`vertex`),n=vc(i,S,`fragment`);G(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`)}async update(e){let t=e.clientWidth||e.offsetWidth,n=e.clientHeight||e.offsetHeight;if(t===0||n===0){let t=this.entries.get(e);return t?t.canvas:this.ensureEntry(e,1,1).canvas}let r=this.ensureEntry(e,t,n),i=Math.max(1,this.pixelRatio),a=r.canvas.width,o=r.canvas.height,s=await this.buildSvg(e,t,n,i);if(s===r.lastSvg)return Jl&&console.log(`[html-in-canvas debug] rasterization skipped (unchanged)`),r.canvas;if(Jl&&r.lastSvg){let e=r.lastSvg.split(`<`),t=s.split(`<`),n=[],i=Math.max(e.length,t.length);for(let r=0;r<i;r++)if(e[r]!==t[r]&&(n.push(`  - ${(e[r]||``).slice(0,120)}`),n.push(`  + ${(t[r]||``).slice(0,120)}`)),n.length>20){n.push(`  ...`);break}console.log(`[html-in-canvas debug] SVG changed:
`+n.join(`
`))}r.lastSvg=s;let c=await Ql(s,a,o);return r.context.clearRect(0,0,a,o),r.context.drawImage(c,0,0,a,o),r.canvas}getCanvas(e){return this.entries.get(e)?.canvas??null}getCssSize(e){let t=this.entries.get(e);return t?{width:t.cssW,height:t.cssH}:null}setPageStyles(e){this.pageStyles=e}async getPageStylesCss(){if(!this.pageStylesCssPromise){let e=$l();this.pageStylesCssPromise=e,e.catch(()=>{this.pageStylesCssPromise===e&&(this.pageStylesCssPromise=null)})}return this.pageStylesCssPromise}invalidatePageStylesCss(){this.pageStylesCssPromise=null}cleanup(){this.entries.clear(),this.pageStylesCssPromise=null,pu.clear(),cu&&=(cu.remove(),null)}captureDynamicStateOnClone(e,t){let n=[e,...e.querySelectorAll(`*`)],r=[t,...t.querySelectorAll(`*`)];if(n.length===r.length){for(let e=0;e<n.length;e++)ou(n[e],r[e]);uu(e,t),du(e,t)}}ensureEntry(e,t,n){let r=Math.max(1,this.pixelRatio),i=Math.max(1,Math.ceil(t*r)),a=Math.max(1,Math.ceil(n*r)),o=this.entries.get(e);if(o)(o.canvas.width!==i||o.canvas.height!==a)&&(o.canvas.width=i,o.canvas.height=a),o.cssW=t,o.cssH=n;else{let r=document.createElement(`canvas`);r.width=i,r.height=a,o={canvas:r,context:r.getContext(`2d`),cssW:t,cssH:n},this.entries.set(e,o)}return o}async buildSvg(e,t,n,r=1){let i=await Xl(e);this.captureDynamicStateOnClone(e,i);let a=Zl(e,new XMLSerializer().serializeToString(i)),o=await this.getPageStylesCss(),s=`<svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${n}" viewBox="0 0 ${t} ${n}"><style><![CDATA[${(eu+`
`+o+`
`+this.pageStyles+`
`+this.svgOnlyStyles).replace(/]]>/g,`]]]]><![CDATA[>`)}]]></style><foreignObject x="0" y="0" width="100%" height="100%">${a}</foreignObject></svg>`;if(Jl){let e=document.getElementById(`__hic-svg-debug__`);e||(e=document.createElement(`div`),e.id=`__hic-svg-debug__`,e.style.cssText=`position:absolute;z-index:99999;pointer-events:none;opacity:0.3;box-sizing:border-box;margin:0;padding:0;border:none;overflow:hidden;`,document.body.appendChild(e));let t=document.querySelector(`canvas`);if(t){let n=t.getBoundingClientRect();e.style.left=n.left+window.scrollX+`px`,e.style.top=n.top+window.scrollY+`px`,e.style.width=n.width+`px`,e.style.height=n.height+`px`}if(!e.innerHTML){e.innerHTML=s;let t=e.querySelector(`svg`);t&&(t.style.width=`100%`,t.style.height=`100%`)}}return s}};async function Xl(e){let t=e.cloneNode(!0);return ql(e,t),fu(e,t),t.style.removeProperty(`transform`),t.style.opacity=`1`,t.style.visibility=`visible`,await hu(t),t.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),t}function Zl(e,t){let n=e.parentElement,r=n?.getAttribute(`class`)||``,i=n?.clientWidth||e.clientWidth||e.offsetWidth,a=n?.clientHeight||e.clientHeight||e.offsetHeight;return`<html xmlns="http://www.w3.org/1999/xhtml" style="margin:0;padding:0;background:transparent !important;"><body style="margin:0;padding:0;background:transparent !important;"><div xmlns="http://www.w3.org/1999/xhtml"${r?` class="${au(r)}"`:``} style="position:relative;width:${i}px;height:${a}px;margin:0;padding:0;">`+t+`</div></body></html>`}async function Ql(e,t,n){let r=`data:image/svg+xml;charset=UTF-8,`+encodeURIComponent(e);try{return await Hl(r)}catch(r){let i=r&&typeof r==`object`&&`type`in r?r.type:typeof r,a=Error(`HtmlRenderer: SVG image failed to load (${i}). cssW=${t}, cssH=${n}, svg.length=${e.length}. svg head: ${e.slice(0,300).replace(/\s+/g,` `)}…`);throw a.cause=r,a.svg=e,a}}async function $l(){let e=[];for(let t of Array.from(document.styleSheets))try{let n=Array.from(t.cssRules||[]);e.push(n.map(e=>e.cssText).join(`
`))}catch{if(!t.href)continue;try{let n=await fetch(t.href);n.ok&&e.push(await n.text())}catch(e){console.warn(`[HtmlRenderer] failed to fetch stylesheet`,t.href,e)}}if(e.length===0)return``;let t;try{t=await Kl(e.join(`
`),async e=>{if(e.startsWith(`http://www.w3.org/`))return e;try{return await mu(e)}catch{return e}})}catch(n){console.warn(`[HtmlRenderer] URL embedding failed`,n),t=e.join(`
`)}let n=ru(t);return n?t+`
`+n:t}var eu=`
...
`,tu=/:(?:hover|focus-visible|focus-within|focus(?!-)|active)\b/g,nu=/:(?:hover|focus-visible|focus-within|focus(?!-)|active)\b/;function ru(e){let t;try{t=new CSSStyleSheet,t.replaceSync(e)}catch{return``}let n=[];return iu(t.cssRules,n),n.join(`
`)}function iu(e,t){for(let n=0;n<e.length;n++){let r=e[n];if(r instanceof CSSStyleRule){if(nu.test(r.selectorText)){let e=r.selectorText.replace(tu,e=>`.pseudo-`+e.slice(1));t.push(`${e} { ${r.style.cssText} }`)}}else if(`cssRules`in r){let e=r,n=[];if(iu(e.cssRules,n),n.length){let e=``;e=r instanceof CSSMediaRule?`@media ${r.conditionText}`:r instanceof CSSSupportsRule?`@supports ${r.conditionText}`:(r.cssText?.split(`{`)[0])?.trim()??``,e&&t.push(`${e} {
${n.join(`
`)}
}`)}}}}function au(e){return e.replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function ou(e,t){(e.scrollLeft!==0||e.scrollTop!==0)&&(t.style.setProperty(`--scroll-left`,-e.scrollLeft+`px`),t.style.setProperty(`--scroll-top`,-e.scrollTop+`px`));let n=e.getAnimations();if(n.length!==1)return;let r=n[0],i=typeof r.currentTime==`number`?r.currentTime:0,a=getComputedStyle(e).animationDelay,o=((a.endsWith(`ms`)?parseFloat(a)/1e3:parseFloat(a))||0)-i/1e3;t.style.setProperty(`--animation-delay`,o+`s`)}var su=`fontFamily.fontSize.fontWeight.fontStyle.fontVariant.lineHeight.letterSpacing.wordSpacing.textIndent.textTransform.whiteSpace.wordWrap.overflowWrap.wordBreak.paddingTop.paddingRight.paddingBottom.paddingLeft.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.boxSizing.width.direction.textAlign`.split(`.`),cu=null;function lu(e,t){cu||(cu=document.createElement(`div`),cu.style.cssText=`position:absolute;left:-9999px;top:-9999px;visibility:hidden;overflow:hidden;`,document.body.appendChild(cu));let n=getComputedStyle(e),r=e instanceof HTMLInputElement;for(let e of su)cu.style[e]=n[e];cu.style.whiteSpace=r?`pre`:n.whiteSpace,cu.style.height=`auto`,cu.style.overflowY=`hidden`;let i=e.value,a=i.substring(0,t);cu.textContent=``;let o=document.createTextNode(a),s=document.createElement(`span`);s.textContent=`|`,cu.appendChild(o),cu.appendChild(s),cu.appendChild(document.createTextNode(i.substring(t)||`.`));let c=parseFloat(n.fontSize),l=parseFloat(n.lineHeight),u=isNaN(l)?c*1.2:n.lineHeight.endsWith(`px`)?l:l*c;return{x:s.offsetLeft,y:s.offsetTop,height:u}}function uu(e,t){let n=document.activeElement;if(!n)return;let r;if(n instanceof HTMLInputElement){let e=n.type;if(e!==`text`&&e!==`search`&&e!==`url`&&e!==`tel`&&e!==`password`&&e!==``)return;r=n}else if(n instanceof HTMLTextAreaElement)r=n;else return;if(!e.contains(r))return;let i=r.selectionStart,a=r.selectionEnd;if(i===null||a===null)return;let o=getComputedStyle(r),s=parseFloat(o.borderLeftWidth)||0,c=parseFloat(o.borderTopWidth)||0,l=0,u=0,d=r;for(;d&&d!==e;)l+=d.offsetLeft,u+=d.offsetTop,d=d.offsetParent;let f=l+s,p=u+c,m=f,h=m+r.clientWidth,g=p,_=g+r.clientHeight;if(i===a){let e=lu(r,i),n=f+e.x-r.scrollLeft,a=p+e.y-r.scrollTop;if(Math.floor(Date.now()/500)%2==0&&n>=m&&n<=h&&a>=g&&a+e.height<=_){let r=document.createElement(`div`);r.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),r.style.cssText=`position:absolute;pointer-events:none;left:${n}px;top:${a}px;width:2px;height:${e.height}px;background:currentColor;`,t.appendChild(r)}}else{let e=lu(r,i),n=lu(r,a),o=e.height,s=r.scrollLeft,c=r.scrollTop;if(e.y===n.y){let r=Math.max(f+e.x-s,m),i=Math.min(f+n.x-s,h),a=p+e.y-c;if(i>r&&a>=g&&a+o<=_){let e=document.createElement(`div`);e.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),e.style.cssText=`position:absolute;pointer-events:none;left:${r}px;top:${a}px;width:${i-r}px;height:${o}px;background:Highlight;opacity:0.5;`,t.appendChild(e)}}else{let r=[];r.push({left:f+e.x-s,right:h,top:p+e.y-c});for(let t=e.y+o;t<n.y;t+=o)r.push({left:m,right:h,top:p+t-c});r.push({left:m,right:f+n.x-s,top:p+n.y-c});for(let e of r){let n=Math.max(e.left,m),r=Math.min(e.right,h);if(r<=n||e.top+o<g||e.top>_)continue;let i=document.createElement(`div`);i.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),i.style.cssText=`position:absolute;pointer-events:none;left:${n}px;top:${e.top}px;width:${r-n}px;height:${o}px;background:Highlight;opacity:0.5;`,t.appendChild(i)}}}}function du(e,t){let n=window.getSelection();if(!n||n.isCollapsed||n.rangeCount===0)return;let r=n.getRangeAt(0);if(!e.contains(r.startContainer)&&!e.contains(r.endContainer))return;let i=e.style.transform,a=e.style.transformOrigin;e.style.transform=`none`,e.style.transformOrigin=``;let o=e.getBoundingClientRect(),s=e.offsetWidth/o.width,c=e.offsetHeight/o.height,l=e.offsetWidth,u=e.offsetHeight,d=r.getClientRects(),f=[];for(let t=0;t<d.length;t++){let n=d[t];f.push({left:(n.left-o.left)*s+e.scrollLeft,top:(n.top-o.top)*c+e.scrollTop,width:n.width*s,height:n.height*c})}e.style.transform=i,e.style.transformOrigin=a;for(let e=0;e<f.length;e++){let{left:n,top:r,width:i,height:a}=f[e];if(n<0&&(i+=n,n=0),r<0&&(a+=r,r=0),n+i>l&&(i=l-n),r+a>u&&(a=u-r),i<=0||a<=0)continue;let o=document.createElement(`div`);o.setAttribute(`xmlns`,`http://www.w3.org/1999/xhtml`),o.style.cssText=`position:absolute;pointer-events:none;left:${n}px;top:${r}px;width:${i}px;height:${a}px;background:Highlight;opacity:0.5;`,t.appendChild(o)}}function fu(e,t){let n=[e,...e.querySelectorAll(`*`)],r=[t,...t.querySelectorAll(`*`)];if(n.length===r.length)for(let e=0;e<n.length;e++){let t=getComputedStyle(n[e]);for(let n of[`fontSize`,`lineHeight`,`height`,`minHeight`,`maxHeight`,`marginTop`,`marginBottom`,`paddingTop`,`paddingBottom`,`borderTopWidth`,`borderBottomWidth`]){let i=parseFloat(t[n]);isNaN(i)||(r[e].style[n]=i%1==0?t[n]:Math.floor(i)+`px`)}}}var pu=new Map;function mu(e){let t=pu.get(e);if(t)return t;let n=fetch(e).then(t=>{if(!t.ok)throw Error(`fetch ${e} → ${t.status}`);return t.blob()}).then(e=>new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(r.result),r.onerror=()=>n(r.error),r.readAsDataURL(e)}));return pu.set(e,n),n.catch(()=>{pu.get(e)===n&&pu.delete(e)}),n}async function hu(e){let t=Array.from(e.querySelectorAll(`img`));await Promise.all(t.map(async e=>{let t=e.getAttribute(`src`);if(!(!t||t.startsWith(`data:`)))try{let n=new URL(t,document.baseURI).href;e.setAttribute(`src`,await mu(n))}catch(n){console.warn(`[HtmlRenderer] failed to inline img`,t,n),e.removeAttribute(`src`)}}))}var gu=new Map,_u=new Yl,vu=!1;function yu(){return _u}var bu=[],xu=[],Su=new WeakMap,Cu=null;function wu(e={}){if(vu)return;if(window.__HTML_IN_CANVAS_POLYFILL__){let e=window.__HIC_UNINSTALL__;if(typeof e==`function`)e();else return}let t=`drawElementImage`in CanvasRenderingContext2D.prototype&&`requestPaint`in HTMLCanvasElement.prototype&&`onpaint`in HTMLCanvasElement.prototype,n=e.force??new URLSearchParams(location.search).has(`polyfillHIC`);if(t&&!n){console.info(`[html-in-canvas] Native API detected, polyfill skipped. Add ?polyfillHIC to URL to force.`);return}vu=!0,window.__HTML_IN_CANVAS_POLYFILL__=!0,window.__HIC_UNINSTALL__=Tu,console.info(`[html-in-canvas] Polyfill installed`+(n?` (forced)`:``)),e.pageStyles&&_u.setPageStyles(e.pageStyles),Ou(),Au(),Mu(),Lu(),Ku(),Ju()}function Tu(){if(vu){for(let e of Array.from(gu.values()))nd(e);gu.clear();for(let[e,t,n]of bu)n?Object.defineProperty(e,t,n):delete e[t];bu.length=0;for(let[e,t,n,r]of xu)e.removeEventListener(t,n,r);xu.length=0,Cu?.disconnect(),Cu=null,Pu=null,_u.cleanup(),vu=!1,window.__HTML_IN_CANVAS_POLYFILL__=!1,delete window.__HIC_UNINSTALL__}}function Eu(e,t){let n=gu.get(e)||Yu(e);if(!n)throw new DOMException(`canvas is not [layoutsubtree]`,`InvalidStateError`);if(!n.children.has(t))throw new DOMException(`element is not a direct child of the canvas`,`InvalidStateError`);return n}function Du(e,t,n,r,i,a){let o=new DOMMatrix().scale(n,r),s=new DOMMatrix().scale(1/n,1/r),c=getComputedStyle(e).transformOrigin.split(` `),l=parseFloat(c[0])||i/2,u=parseFloat(c[1])||a/2,d=new DOMMatrix().translate(l,u);return new DOMMatrix().translate(-l,-u).multiply(s).multiply(t).multiply(o).multiply(d)}function Ou(){Gu(CanvasRenderingContext2D.prototype,`drawElementImage`,{configurable:!0,writable:!0,value:ku})}function ku(e,t,n,r,i){let a=this.canvas;Eu(a,e);let o=_u.getCanvas(e),s=_u.getCssSize(e);if(!o||!s)return new DOMMatrix;let c=s.width,l=s.height,u=a.width/Math.max(1,a.clientWidth),d=a.height/Math.max(1,a.clientHeight),f=r??c*u,p=i??l*d;return this.drawImage(o,t,n,f,p),Du(e,this.getTransform().translate(t,n).scale(f/(c*u),p/(l*d)),u,d,c,l)}function Au(){typeof WebGLRenderingContext<`u`&&Gu(WebGLRenderingContext.prototype,`texElementImage2D`,{configurable:!0,writable:!0,value:ju}),typeof WebGL2RenderingContext<`u`&&Gu(WebGL2RenderingContext.prototype,`texElementImage2D`,{configurable:!0,writable:!0,value:ju})}function ju(e,t,n,...r){let i,a,o;if(r.length===3)[i,a,o]=r;else if(r.length===5)console.warn(`[html-in-canvas polyfill] texElementImage2D(width,height,...) overload: dest resize not implemented, uploading at bitmap size`),[,,i,a,o]=r;else if(r.length===7)console.warn(`[html-in-canvas polyfill] texElementImage2D(sx,sy,swidth,sheight,...) overload: source crop not implemented, uploading full bitmap`),[,,,,i,a,o]=r;else if(r.length===9)console.warn(`[html-in-canvas polyfill] texElementImage2D(sx,sy,swidth,sheight,width,height,...) overload: source crop + dest resize not implemented, uploading full bitmap`),[,,,,,,i,a,o]=r;else throw TypeError(`texElementImage2D: unexpected argument count ${3+r.length}`);if(!(o instanceof HTMLElement))throw TypeError(`texElementImage2D: element must be an HTMLElement`);let s=_u.getCanvas(o);if(!s)throw new DOMException("texElementImage2D: no snapshot recorded yet for this element. Call from inside the canvas `onpaint` handler or after at least one `requestPaint()` + rAF cycle.",`InvalidStateError`);this.texImage2D(e,t,n,i,a,s)}function Mu(){let e=globalThis.GPUQueue;!e||!e.prototype||Gu(e.prototype,`copyElementImageToTexture`,{configurable:!0,writable:!0,value:Nu})}function Nu(...e){let t,n,r,i;if(e.length===2)[t,n]=e,r=0,i=0;else if(e.length===4)[t,r,i,n]=e;else throw TypeError(`copyElementImageToTexture: expected 2 or 4 args, got ${e.length}`);if(!(t instanceof HTMLElement))throw TypeError(`copyElementImageToTexture: source must be an HTMLElement`);let a=_u.getCanvas(t);if(!a)throw new DOMException("copyElementImageToTexture: no snapshot recorded yet for this element. Call from inside the canvas `onpaint` handler or after at least one `requestPaint()` + rAF cycle.",`InvalidStateError`);r===0&&(r=a.width),i===0&&(i=a.height);let o=a;if(a.width!==r||a.height!==i){o=Fu(r,i);let e=o.getContext(`2d`);e.clearRect(0,0,r,i),e.imageSmoothingEnabled=!0,e.imageSmoothingQuality=`high`,e.drawImage(a,0,0,r,i)}this.copyExternalImageToTexture({source:o},n,[r,i])}var Pu=null;function Fu(e,t){return Pu||=document.createElement(`canvas`),Pu.width!==e&&(Pu.width=e),Pu.height!==t&&(Pu.height=t),Pu}function Iu(e,t){let n=this;Eu(n,e);let r=_u.getCssSize(e);if(!r)throw new DOMException(`no snapshot recorded yet`,`InvalidStateError`);return Du(e,t,n.width/Math.max(1,n.clientWidth),n.height/Math.max(1,n.clientHeight),r.width,r.height)}function Lu(){Gu(HTMLCanvasElement.prototype,`layoutSubtree`,{configurable:!0,get(){return this.hasAttribute(`layoutsubtree`)},set(e){e?this.setAttribute(`layoutsubtree`,``):this.removeAttribute(`layoutsubtree`)}}),Gu(HTMLCanvasElement.prototype,`onpaint`,{configurable:!0,get(){return gu.get(this)?.onpaint??null},set(e){let t=Yu(this);t?t.onpaint=e:e&&console.warn("[html-in-canvas polyfill] setting onpaint on a canvas without `layoutsubtree` — the handler will never fire. Add the `layoutsubtree` attribute first.")}}),Gu(HTMLCanvasElement.prototype,`requestPaint`,{configurable:!0,writable:!0,value:function(){let e=Yu(this);if(e){for(let t of e.children)e.dirty.add(t);id(e,`requestPaint`)}}}),Gu(HTMLCanvasElement.prototype,`getElementTransform`,{configurable:!0,writable:!0,value:Iu}),Gu(HTMLCanvasElement.prototype,`captureElementImage`,{configurable:!0,writable:!0,value:function(e){Eu(this,e);let t=_u.getCanvas(e);if(!t)throw new DOMException(`no snapshot recorded yet`,`InvalidStateError`);return t}}),Ru(`children`,e=>e.children),Ru(`firstElementChild`,e=>e.firstElementChild),Ru(`lastElementChild`,e=>e.lastElementChild),Ru(`childElementCount`,e=>e.childElementCount),Vu(),Hu(),Wu()}function Ru(e,t){let n=Object.getOwnPropertyDescriptor(Element.prototype,e);Gu(HTMLCanvasElement.prototype,e,{configurable:!0,get(){let e=gu.get(this);return e&&this.hasAttribute(`layoutsubtree`)?t(e.host):n.get.call(this)}})}function zu(e,t,n){e.children.has(t)||(n?e.host.insertBefore(t,n):e.host.appendChild(t),t.style.position=`absolute`,t.style.left=`0`,t.style.top=`0`,t.style.opacity=`0`,t.style.pointerEvents=`auto`,e.children.add(t),e.dirty.add(t),Su.set(t,e.canvas),id(e,`addChildToState`))}function Bu(e,t){return e.children.has(t)?(e.host.removeChild(t),e.children.delete(t),e.dirty.delete(t),Su.delete(t),t.style.removeProperty(`position`),t.style.removeProperty(`left`),t.style.removeProperty(`top`),t.style.removeProperty(`opacity`),t.style.removeProperty(`pointer-events`),t.style.removeProperty(`transform-origin`),!0):!1}function Vu(){let e=Node.prototype.appendChild;Gu(HTMLCanvasElement.prototype,`appendChild`,{configurable:!0,writable:!0,value:function(t){let n=gu.get(this);return n&&this.hasAttribute(`layoutsubtree`)&&t instanceof HTMLElement?(zu(n,t),t):e.call(this,t)}});let t=Node.prototype.removeChild;Gu(HTMLCanvasElement.prototype,`removeChild`,{configurable:!0,writable:!0,value:function(e){let n=gu.get(this);return n&&e instanceof HTMLElement&&Bu(n,e)?e:t.call(this,e)}});let n=Node.prototype.insertBefore;Gu(HTMLCanvasElement.prototype,`insertBefore`,{configurable:!0,writable:!0,value:function(e,t){let r=gu.get(this);return r&&this.hasAttribute(`layoutsubtree`)&&e instanceof HTMLElement?(zu(r,e,t),e):n.call(this,e,t)}}),Gu(HTMLCanvasElement.prototype,`contains`,{configurable:!0,writable:!0,value:function(e){let t=gu.get(this);return t&&e&&t.host.contains(e)?!0:Node.prototype.contains.call(this,e)}})}function Hu(){for(let e of[`parentNode`,`parentElement`]){let t=Object.getOwnPropertyDescriptor(Node.prototype,e);Gu(Node.prototype,e,{configurable:!0,get(){return Su.get(this)??t.get.call(this)}})}}var Uu=new Set([`mousemove`,`mousedown`,`mouseup`,`mouseenter`,`mouseleave`,`mouseover`,`mouseout`,`click`,`dblclick`,`contextmenu`,`wheel`,`pointerdown`,`pointerup`,`pointermove`,`pointerenter`,`pointerleave`,`pointerover`,`pointerout`]);function Wu(){let e=EventTarget.prototype.addEventListener,t=EventTarget.prototype.removeEventListener,n=new WeakMap;Gu(HTMLCanvasElement.prototype,`addEventListener`,{configurable:!0,writable:!0,value:function(t,r,i){e.call(this,t,r,i);let a=gu.get(this);if(a&&Uu.has(t)&&r){let o=typeof r==`function`?r.bind(this):r;n.set(r,o),e.call(a.host,t,o,i)}}}),Gu(HTMLCanvasElement.prototype,`removeEventListener`,{configurable:!0,writable:!0,value:function(e,r,i){t.call(this,e,r,i);let a=gu.get(this);if(a&&Uu.has(e)&&r){let o=n.get(r);o&&(t.call(a.host,e,o,i),n.delete(r))}}})}function Gu(e,t,n){bu.push([e,t,Object.getOwnPropertyDescriptor(e,t)]),Object.defineProperty(e,t,n)}function Ku(){let e=()=>{for(let e of gu.values())e.positionHost()};qu(window,`scroll`,e,{passive:!0}),qu(window,`resize`,e)}function qu(e,t,n,r){e.addEventListener(t,n,r),xu.push([e,t,n,r])}function Ju(){let e=()=>{vu&&document.querySelectorAll(`canvas[layoutsubtree]`).forEach(Yu)};document.readyState===`loading`?qu(document,`DOMContentLoaded`,e,{once:!0}):e(),Cu=new MutationObserver(e=>{for(let t of e)if(t.type===`attributes`&&t.attributeName===`layoutsubtree`){let e=t.target;if(!(e instanceof HTMLCanvasElement))continue;if(e.hasAttribute(`layoutsubtree`))Yu(e);else{let t=gu.get(e);t&&(nd(t),gu.delete(e))}}else if(t.type===`childList`)for(let e of Array.from(t.addedNodes))e instanceof HTMLCanvasElement&&e.hasAttribute(`layoutsubtree`)?Yu(e):e instanceof Element&&e.querySelectorAll(`canvas[layoutsubtree]`).forEach(Yu)}),Cu.observe(document.documentElement,{attributes:!0,subtree:!0,attributeFilter:[`layoutsubtree`],childList:!0})}function Yu(e){let t=gu.get(e);if(t)return t;if(!e.hasAttribute(`layoutsubtree`))return null;let n=Xu(e),r=new Set,i=new Set,a=[],o=()=>{let t=e.getBoundingClientRect();n.style.left=t.left+window.scrollX+e.clientLeft+`px`,n.style.top=t.top+window.scrollY+e.clientTop+`px`,n.style.width=e.clientWidth+`px`,n.style.height=e.clientHeight+`px`},s={canvas:e,host:n,children:r,dirty:i,onpaint:null,rafHandle:0,caretBlinkInterval:null,positionHost:o,observers:a,cleanups:[]};return Zu(n,s),gu.set(e,s),ed(s),o(),td(s),s}function Xu(e){let t=document.createElement(`div`);return t.setAttribute(`data-html-in-canvas-host`,``),e.className&&(t.className=e.className),e.id&&t.setAttribute(`data-host-of`,e.id),t.style.cssText=`position:absolute;left:0;top:0;margin:0;padding:0;pointer-events:auto;transform-style:preserve-3d;`,document.body.appendChild(t),t}function Zu(e,t){let n=(e=`hostListener`)=>{for(let e of t.children)t.dirty.add(e);id(t,e)};e.addEventListener(`load`,e=>{e.target instanceof HTMLImageElement&&n(`image-load`)},!0),e.addEventListener(`input`,()=>n(`input`),!0),e.addEventListener(`change`,()=>n(`change`),!0);let r=()=>{let t=window.getSelection(),r=t&&!t.isCollapsed&&t.rangeCount>0&&e.contains(t.getRangeAt(0).startContainer);(e.contains(document.activeElement)||r)&&n(`selectionchange`)};document.addEventListener(`selectionchange`,r),t.cleanups.push(()=>document.removeEventListener(`selectionchange`,r)),e.addEventListener(`mouseover`,t=>{let n=t.target;if(n.classList){n.classList.add(`pseudo-hover`);for(let t of Qu(n,e))t.classList.add(`pseudo-hover`)}},!0),e.addEventListener(`mouseout`,e=>{let t=e.target;if(t.classList){t.classList.remove(`pseudo-hover`);for(let e of t.querySelectorAll(`.pseudo-hover`))e.classList.remove(`pseudo-hover`)}},!0),e.addEventListener(`focusin`,r=>{let i=r.target;if(i.classList){i.classList.add(`pseudo-focus`);for(let t of Qu(i,e))t.classList.add(`pseudo-focus-within`);try{i.matches(`:focus-visible`)&&i.classList.add(`pseudo-focus-visible`)}catch{}(i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement)&&(t.caretBlinkInterval&&clearInterval(t.caretBlinkInterval),t.caretBlinkInterval=setInterval(()=>n(`caret-blink`),500))}},!0),e.addEventListener(`focusout`,r=>{let i=r.target;i.classList&&i.classList.remove(`pseudo-focus`,`pseudo-focus-visible`);for(let t of e.querySelectorAll(`.pseudo-focus-within`))t.classList.remove(`pseudo-focus-within`);t.caretBlinkInterval&&(clearInterval(t.caretBlinkInterval),t.caretBlinkInterval=null,n(`caret-remove`))},!0),e.addEventListener(`pointerdown`,t=>{let n=t.target;if(n.classList){n.classList.add(`pseudo-active`);for(let t of Qu(n,e))t.classList.add(`pseudo-active`)}},!0);let i=()=>{for(let t of e.querySelectorAll(`.pseudo-active`))t.classList.remove(`pseudo-active`)};e.addEventListener(`pointerup`,i,!0),e.addEventListener(`pointercancel`,i,!0)}function Qu(e,t){let n=[],r=e.parentElement;for(;r&&r!==t;)n.push(r),r=r.parentElement;return n}var $u=Object.getOwnPropertyDescriptor(Element.prototype,`children`).get;function ed(e){for(let t of Array.from($u.call(e.canvas)))zu(e,t)}function td(e){let t=new ResizeObserver(()=>{e.positionHost();for(let t of e.children)e.dirty.add(t);id(e,`ResizeObserver`)});t.observe(e.canvas),e.observers.push(t);let n=new MutationObserver(t=>{let n=!1;for(let r of t){let t=r.target;for(;t&&!(t instanceof HTMLElement&&e.children.has(t));)t=t.parentNode;t&&(e.dirty.add(t),n=!0)}n&&id(e,`MutationObserver`)});n.observe(e.host,{childList:!0,subtree:!0,attributes:!0,characterData:!0}),e.observers.push(n)}function nd(e){e.rafHandle&&=(cancelAnimationFrame(e.rafHandle),0),e.caretBlinkInterval&&=(clearInterval(e.caretBlinkInterval),null);for(let t of e.cleanups)t();e.cleanups.length=0;for(let t of e.observers)t.disconnect();e.observers.length=0,e.dirty.clear(),e.onpaint=null;let t=[`pseudo-hover`,`pseudo-focus`,`pseudo-focus-visible`,`pseudo-focus-within`,`pseudo-active`];for(let n of Array.from(e.children)){n.classList.remove(...t);for(let e of n.querySelectorAll(`.pseudo-hover, .pseudo-focus, .pseudo-focus-visible, .pseudo-focus-within, .pseudo-active`))e.classList.remove(...t);Bu(e,n),Node.prototype.appendChild.call(e.canvas,n)}e.host.remove()}var rd=typeof location<`u`&&new URLSearchParams(location.search).has(`debugPolyfillHIC`);function id(e,t){rd&&t&&console.trace(`[html-in-canvas debug] schedulePaint from:`,t),!e.rafHandle&&(e.rafHandle=requestAnimationFrame(async()=>{var t;if(e.rafHandle=0,!gu.has(e.canvas))return;e.positionHost();let n=Array.from(e.dirty);if(e.dirty.clear(),n.length&&await Promise.all(n.map(ad)),!gu.has(e.canvas))return;let r=new Event(`paint`);r.changedElements=n;try{(t=e.onpaint)==null||t.call(e.canvas,r)}catch(e){console.error(`[html-in-canvas polyfill] onpaint threw`,e)}e.canvas.dispatchEvent(r)}))}async function ad(e){try{await _u.update(e)}catch(t){console.error(`[html-in-canvas polyfill] rasterize failed for ${od(e)}:`,t instanceof Error?t.message+`
`+t.stack:t)}}function od(e){let t=e.tagName.toLowerCase(),n=e.id?`#${e.id}`:``,r=e.getAttribute(`class`)||``;return`<${t}${n}${r?`.${r.trim().replace(/\s+/g,`.`)}`:``}>`}function sd(){if(!window.__HTML_IN_CANVAS_POLYFILL__)return;let e=[globalThis.WebGLRenderingContext,globalThis.WebGL2RenderingContext];for(let t of e){if(!t)continue;let e=t.prototype,n=e.texElementImage2D;!n||n.length!==3||Object.defineProperty(e,"texElementImage2D",{configurable:!0,writable:!0,value:function(e,t,r,i,a,o){n.call(this,e,t,r,i,a,o)}})}}var cd=e({MoriaLightCanvas:()=>fd}),ld=new J(0,-1,0),ud=new J(0,1,0),dd=ld.clone();function fd({onReady:e,onError:t}){let n=(0,i.useRef)(null),r=(0,i.useRef)(null),s=(0,i.useRef)(null),c=(0,i.useRef)(new Z),l=(0,i.useRef)(null),[u,d]=(0,i.useState)(o),f=(0,i.useRef)(u),[m,h]=(0,i.useState)(!1),[g,y]=(0,i.useState)(!1),[b,x]=(0,i.useState)(``);return(0,i.useEffect)(()=>{let e=!0;n.current?.setAttribute(`layoutsubtree`,``);try{wu();let t=window.innerWidth<760?2.5:3;yu().pixelRatio=Math.max(t,window.devicePixelRatio||1),sd(),queueMicrotask(()=>{e&&h(!0)})}catch(n){console.error(`HTML-in-Canvas could not be initialized.`,n),queueMicrotask(()=>{e&&(x(`HTML-in-Canvas is not available in this browser.`),t?.())})}return()=>{e=!1}},[t]),(0,i.useEffect)(()=>{if(!m)return;let i=n.current,c=r.current;if(!i||!c)return;let u=!1,p=0,h=0,g=0,_=0,v=null,b=performance.now(),S=0,C=0,w=!1,E=-1,D=0,O=0,k=-1,A=0,j=0,ee=o.angle,M=!1,N=1/120,P=1.22,te=1,ne=new J(0,-9.81,0),re=new J(0,4.72,1.18),F=new J(.16,re.y-P,re.z+.08),ie=F.clone().add(new J(.018,0,-.012)),I=new J(0,.3,.08),ae=new J,oe=I.clone(),L=new J,se=new J,ce=new J,le=new J,ue=new J,de=new J,fe=dd.clone(),pe=new J,me=new Vt,he=new Vt,ge=new Vt,_e=new q,ve=new J,ye=new Fi(new J(0,0,1),-.08),be=new po,xe;try{xe=new Nl({canvas:i,antialias:!0,alpha:!0,powerPreference:`high-performance`})}catch(e){console.error(e);let n=window.setTimeout(()=>{u||(x(`This experience needs WebGL to render the Moria light study.`),t?.())},0);return()=>{u=!0,window.clearTimeout(n)}}xe.outputColorSpace=Qe,xe.toneMapping=7,xe.toneMappingExposure=1.08,xe.setClearColor(66052,1);let Se=new Kn;Se.background=new Z(66052);let Ce=new Va(37,1,.1,80);Ce.position.set(0,.2,13.6);let we=new Rn;we.position.set(0,-.35,0),Se.add(we);let Te=new Hi(c);Te.colorSpace=Qe,Te.minFilter=T,Te.magFilter=T,Te.generateMipmaps=!1;let Ee=new Xi(1,1,1,1),De=new la({map:Te,color:12962516,roughness:.96,metalness:0,transparent:!0,alphaTest:.005,side:0}),Oe=new Oi(Ee,De);we.add(Oe);let ke=new la({color:526864,roughness:.9,metalness:.03}),Ae=new Oi(new Xi(1.018,1.028),ke);Ae.position.z=-.035,we.add(Ae);let R=new ka(7438491,1380632,.58);Se.add(R);let je=new Ja(9545416,.24);je.position.set(-4.8,5.6,7.4),Se.add(je);let z=new Rn;Se.add(z);let Me=new Oi(new Ji(.24,.3,.11,24),new la({color:1053208,roughness:.64,metalness:.7}));Me.position.copy(re).add(new J(0,.08,0)),Se.add(Me);let B=new Oi(new Ji(.014,.014,1,10),new la({color:1184536,roughness:.5,metalness:.55}));Se.add(B);let Ne=new Rn;z.add(Ne);let V=[new q(.08,.08),new q(.18,.02),new q(.43,-.1),new q(.82,-.25),new q(1.08,-.36),new q(1.1,-.41)],H=new la({color:1052950,roughness:.36,metalness:.74,side:2}),Pe=new Oi(new Yi(V,48),H);Ne.add(Pe);let Fe=new Oi(new Qi(1.095,.027,8,48),new la({color:1513759,roughness:.28,metalness:.82}));Fe.rotation.x=Math.PI/2,Fe.position.y=-.397,Ne.add(Fe);let Ie=new la({color:new Z(o.color).multiplyScalar(.18),emissive:o.color,emissiveIntensity:.42,roughness:.92,side:2}),Le=new Oi(new qi(1.055,48),Ie);Le.rotation.x=Math.PI/2,Le.position.y=-.385,Ne.add(Le);let Re=new Oi(new Ji(.095,.12,.2,20),new la({color:10250052,roughness:.44,metalness:.66}));Re.position.y=.08,Ne.add(Re);let ze=new la({color:16766893,emissive:o.color,emissiveIntensity:3.2,roughness:.2}),Be=new Oi(new Zi(.16,20,12),ze);Be.scale.y=1.2,Be.position.y=-.33,Ne.add(Be);let Ve=qe(),He=new Kr({map:Ve,color:o.color,transparent:!0,opacity:.86,depthWrite:!1,blending:2}),Ue=new oi(He);Ue.position.y=-.36,Ue.scale.set(.96,.96,.96),Ne.add(Ue);let We=new Ua(o.color,1,18,Bt.degToRad(o.angle),.88,2);We.power=o.brightness,We.position.set(0,-.35,0),We.target.position.set(0,-7,0),Ne.add(We,We.target);let Ge=new Ga(o.color,1,3.2,2);Ge.power=36,Ge.position.set(0,-.35,0),Ne.add(Ge),s.current={spot:We,bulbLight:Ge,bulbMaterial:ze,glowMaterial:He,undersideMaterial:Ie};let Ke=new Rl;Ke.connect(xe,Ce),Ke.add(Oe);function qe(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);if(t){let e=t.createRadialGradient(32,32,0,32,32,32);e.addColorStop(0,`rgba(255,255,255,1)`),e.addColorStop(.16,`rgba(255,222,172,.8)`),e.addColorStop(.46,`rgba(255,170,94,.22)`),e.addColorStop(1,`rgba(255,140,70,0)`),t.fillStyle=e,t.fillRect(0,0,64,64)}let n=new Vi(e);return n.colorSpace=Qe,n}function Je(e=!0){let t=Math.max(1,i.clientWidth),n=Math.max(1,i.clientHeight),r=Math.min(window.devicePixelRatio||1,t<760?1.5:2);xe.setPixelRatio(r),xe.setSize(t,n,!1),Ce.aspect=t/n,Ce.updateProjectionMatrix();let a=c.offsetWidth||t,o=c.offsetHeight||n,s=n>t*1.16,l=s?7.2:12.8,u=o/a*l;Oe.scale.set(l,u,1),Ae.scale.set(l,u,1);let d=s?Bt.clamp(t*.3,110,200):Bt.clamp(Math.min(t*.17,n*.34),140,280),f=l/t,p=u/n;te=d*f/2.2,z.scale.setScalar(te),Me.scale.setScalar(te),P=Bt.clamp(n*(s?.13:.16),s?72:80,150)*p,we.position.y=0;let m=s?18:12;if(re.set(0,u/2-m*p,s?1.1:1.18),Me.position.copy(re),Me.position.y+=.08*te,!w){let e=L.copy(F).sub(re);e.lengthSq()<.001&&e.copy(ld),e.normalize().multiplyScalar(P),F.copy(re).add(e),ie.copy(F)}let h=Bt.degToRad(Ce.fov*.5),g=u/(2*Math.tan(h));Ce.position.set(0,0,g),Ce.lookAt(0,0,0),Ce.updateMatrixWorld(),Ke.update(),i.requestPaint?.(),e&&U()}function Ye(){ue.copy(F).sub(re).normalize(),pe.copy(re).add(F).multiplyScalar(.5),B.position.copy(pe),B.scale.set(te,P,te),ge.setFromUnitVectors(ud,ue),B.quaternion.copy(ge),w?(de.copy(I).sub(F).normalize(),fe.lerp(de,.32).normalize()):(me.setFromUnitVectors(ld,ue),de.copy(dd).applyQuaternion(me).normalize(),fe.lerp(de,.14).normalize()),he.setFromUnitVectors(ld,fe),z.position.copy(F),z.quaternion.copy(he)}function Xe(){le.copy(F).sub(ie).multiplyScalar(w?.985:.9948),ie.copy(F),F.add(le).addScaledVector(ne,N*N),w&&(se.copy(I).sub(re).normalize(),se.lerp(ld,1-O*.82).normalize(),ce.copy(se).multiplyScalar(P).add(re).sub(F),L.copy(F).sub(re).normalize(),ce.addScaledVector(L,-ce.dot(L)),F.addScaledVector(ce,52*N*N)),L.copy(F).sub(re),L.lengthSq()<1e-8&&L.copy(ld),L.normalize().multiplyScalar(P),F.copy(re).add(L),le.copy(F).sub(ie),w?C=0:le.lengthSq()<14e-9?C+=1:C=0}function Ze(e){if(h=0,u)return;let t=Math.min((e-b)/1e3,.05);for(b=e,S=Math.min(S+t,N*5);S>=N;)Xe(),S-=N;Ye(),Ke.update(),xe.render(Se,Ce),p+=1,(w||C<80||p<4)&&(h=requestAnimationFrame(Ze))}function U(){C=0,!h&&!u&&(b=performance.now(),h=requestAnimationFrame(Ze))}l.current=U;function $e(e){let t=i.getBoundingClientRect();_e.x=(e.clientX-t.left)/t.width*2-1,_e.y=-((e.clientY-t.top)/t.height)*2+1,be.setFromCamera(_e,Ce)}function et(e){if($e(e),!be.ray.intersectPlane(ye,I))return!1;ve.copy(F).project(Ce);let t=(_e.x-ve.x)*Ce.aspect,n=_e.y-ve.y,r=Math.sqrt(t*t+n*n);return O=Bt.smoothstep(r,.08,1.15),!0}function tt(e){if(e.button===2){k=e.pointerId,A=e.clientX,j=e.clientY,ee=f.current.angle,M=!1,c.classList.add(`is-adjusting-beam`);return}e.button!==0||k!==-1||et(e)&&(w=!0,E=e.pointerId,D=performance.now(),oe.copy(I),ae.set(0,0,0),i.classList.add(`is-pulling-light`),U())}function nt(e){if(e.pointerId===k){let t=e.clientX-A,n=e.clientY-j;if(!M&&Math.hypot(t,n)>=4&&(M=!0),M){let e=Bt.clamp(Math.round(ee+t*.14),16,60);d(t=>t.angle===e?t:{...t,angle:e}),U()}return}if(!w||e.pointerId!==E||!et(e))return;let t=performance.now(),n=Math.max(.008,Math.min(.05,(t-D)/1e3));L.copy(I).sub(oe).multiplyScalar(1/n),ae.lerp(L,.34),oe.copy(I),D=t,U()}function rt(e){if(e.pointerId===k){let t=!M&&e.type!==`pointercancel`;k=-1,M=!1,c.classList.remove(`is-adjusting-beam`),t&&d(e=>{let t=a[(a.findIndex(t=>t===e.color.toLowerCase())+1)%a.length];return{...e,color:t}}),U();return}if(!w||e.pointerId!==E)return;le.copy(F).sub(ie).multiplyScalar(1/N),L.copy(F).sub(re).normalize(),ae.addScaledVector(L,-ae.dot(L)).clampLength(0,6);let t=Bt.lerp(.055,.12,O);if(le.addScaledVector(ae,t),se.copy(re).addScaledVector(ld,P).sub(F),se.addScaledVector(L,-se.dot(L)),se.lengthSq()>1e-4){se.normalize();let e=Bt.lerp(.32,1.6,O);le.addScaledVector(se,e)}le.clampLength(0,4.25),ie.copy(F).addScaledVector(le,-.008333333333333333),w=!1,E=-1,O=0,i.classList.remove(`is-pulling-light`),U()}function it(){w=!1,E=-1,O=0,F.copy(re).addScaledVector(ld,P),ie.copy(F),ae.set(0,0,0),fe.copy(dd),i.classList.remove(`is-pulling-light`),k=-1,M=!1,c.classList.remove(`is-adjusting-beam`),U()}function at(){cancelAnimationFrame(g),g=requestAnimationFrame(()=>Je())}function ot(){U()}function st(e){e.preventDefault()}i.addEventListener(`pointerdown`,tt),i.addEventListener(`dblclick`,it),i.addEventListener(`contextmenu`,st),window.addEventListener(`pointermove`,nt,{passive:!0}),window.addEventListener(`pointerup`,rt),window.addEventListener(`pointercancel`,rt),window.addEventListener(`resize`,at,{passive:!0}),i.addEventListener(`paint`,ot);function ct(){let e=i.requestPaint;return e?new Promise((t,n)=>{v=()=>{window.clearTimeout(_),v=null,t()},_=window.setTimeout(()=>{v&&=(i.removeEventListener(`paint`,v),null),n(Error(`Timed out while preparing the interactive HTML surface.`))},3e4),i.addEventListener(`paint`,v,{once:!0}),e.call(i)}):Promise.resolve()}function lt(e){return e instanceof DOMException&&e.name===`InvalidStateError`&&e.message.includes(`snapshot`)}async function ut(){if(!u){Je(!1),Ye(),Ke.update();try{xe.render(Se,Ce)}catch(e){if(!lt(e))throw e;if(await ct(),u)return;Je(!1),Ye(),Ke.update(),xe.render(Se,Ce)}p+=1,y(!0),e?.(),U()}}return document.fonts.ready.then(ut).catch(e=>{u||(console.error(`Interactive light initialization failed.`,e),x(`The interactive light could not be initialized in this browser.`),t?.())}),()=>{u=!0,cancelAnimationFrame(h),cancelAnimationFrame(g),window.clearTimeout(_),v&&i.removeEventListener(`paint`,v),i.removeEventListener(`pointerdown`,tt),i.removeEventListener(`dblclick`,it),i.removeEventListener(`contextmenu`,st),window.removeEventListener(`pointermove`,nt),window.removeEventListener(`pointerup`,rt),window.removeEventListener(`pointercancel`,rt),window.removeEventListener(`resize`,at),i.removeEventListener(`paint`,ot),Ke.disconnect(),l.current=null,s.current=null,Te.dispose(),Ee.dispose(),De.dispose(),Ae.geometry.dispose(),ke.dispose(),Pe.geometry.dispose(),H.dispose(),Fe.geometry.dispose(),Fe.material.dispose(),Le.geometry.dispose(),Ie.dispose(),Re.geometry.dispose(),Re.material.dispose(),Be.geometry.dispose(),ze.dispose(),B.geometry.dispose(),B.material.dispose(),Me.geometry.dispose(),Me.material.dispose(),Ve.dispose(),He.dispose(),xe.dispose()}},[m,t,e]),(0,i.useEffect)(()=>{f.current=u;let e=s.current;if(!e)return;let t=c.current.set(u.color),r=u.enabled?u.brightness:0;e.spot.color.copy(t),e.spot.power=r,e.spot.angle=Bt.degToRad(u.angle),e.bulbLight.color.copy(t),e.bulbLight.power=u.enabled?Math.max(18,u.brightness*.026):0,e.bulbMaterial.emissive.copy(t),e.bulbMaterial.emissiveIntensity=u.enabled?2.4+u.brightness/850:.04,e.glowMaterial.color.copy(t),e.glowMaterial.opacity=u.enabled?.52+u.brightness/4200:0,e.undersideMaterial.color.copy(t).multiplyScalar(.18),e.undersideMaterial.emissive.copy(t),e.undersideMaterial.emissiveIntensity=u.enabled?.22+u.brightness/7250:.03,n.current?.requestPaint?.(),l.current?.()},[u]),(0,p.jsxs)(`main`,{className:`experience-shell${g?` is-ready`:``}`,"aria-label":`Interactive Moria light study`,"aria-busy":!g&&!b,children:[(0,p.jsx)(`canvas`,{ref:n,className:`webgl-canvas`,"aria-label":`Interactive Moria light study`,children:(0,p.jsx)(_,{sourceRef:r,lighting:u})}),(0,p.jsx)(v,{hidden:g||!!b}),(0,p.jsxs)(`div`,{className:`scene-status${g||b?` is-hidden`:``}`,"aria-live":`polite`,children:[(0,p.jsx)(`span`,{}),` PREPARING HTML SURFACE`]}),b?(0,p.jsx)(`div`,{className:`scene-error`,children:b}):null]})}export{r as a,o as i,_ as n,f as r,cd as t};