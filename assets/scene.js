...
`+t.stack:t)}}function ed(e){let t=e.tagName.toLowerCase(),n=e.id?`#${e.id}`:``,r=e.getAttribute(`class`)||``;return`<${t}${n}${r?`.${r.trim().replace(/\s+/g,`.`)}`:``}>`}function td(){if(!window.__HTML_IN_CANVAS_POLYFILL__)return;let e=[globalThis.WebGLRenderingContext,globalThis.WebGL2RenderingContext];for(let t of e){if(!t)continue;let e=t.prototype,n=e.texElementImage2D;!n||n.length!==3||Object.defineProperty(e,"texElementImage2D",{configurable:!0,writable:!0,value:function(e,t,r,i,a,o){n.call(this,e,t,r,i,a,o)}})}}var nd=e({MoriaLightCanvas:()=>od}),rd=new J(0,-1,0),id=new J(0,1,0),ad=rd.clone();function od({onReady:e,onError:t}){let n=(0,i.useRef)(null),r=(0,i.useRef)(null),s=(0,i.useRef)(null),c=(0,i.useRef)(new Z),u=(0,i.useRef)(null),[p,m]=(0,i.useState)(o),h=(0,i.useRef)(p),[g,_]=(0,i.useState)(!1),[v,b]=(0,i.useState)(!1),[x,S]=(0,i.useState)(``);return(0,i.useEffect)(()=>{let e=!0;n.current?.setAttribute(`layoutsubtree`,``);try{vu();let t=window.innerWidth<760?2.5:3;pu().pixelRatio=Math.max(t,window.devicePixelRatio||1),td(),queueMicrotask(()=>{e&&_(!0)})}catch(n){console.error(`HTML-in-Canvas could not be initialized.`,n),queueMicrotask(()=>{e&&(S(`HTML-in-Canvas is not available in this browser.`),t?.())})}return()=>{e=!1}},[t]),(0,i.useEffect)(()=>{if(!g)return;let i=n.current,c=r.current;if(!i||!c)return;let l=!1,d=0,f=0,p=0,_=0,v=null,x=performance.now(),C=0,w=0,T=!1,E=-1,D=0,O=0,k=-1,A=0,ee=0,te=o.angle,j=!1,M=1/120,N=1.22,ne=1,re=new J(0,-9.81,0),ie=new J(0,4.72,1.18),P=new J(.16,ie.y-N,ie.z+.08),ae=P.clone().add(new J(.018,0,-.012)),oe=new J(0,.3,.08),F=new J,se=oe.clone(),I=new J,L=new J,ce=new J,le=new J,ue=new J,de=new J,fe=ad.clone(),pe=new J,me=new Ft,he=new Ft,ge=new Ft,_e=new q,ve=new J,ye=new ki(new J(0,0,1),-.08),be=new oo,xe;try{xe=new Dl({canvas:i,antialias:!0,alpha:!0,powerPreference:`high-performance`})}catch(e){console.error(e);let n=window.setTimeout(()=>{l||(S(`This experience needs WebGL to render the Moria light study.`),t?.())},0);return()=>{l=!0,window.clearTimeout(n)}}xe.outputColorSpace=Ke,xe.toneMapping=7,xe.toneMappingExposure=1.08,xe.setClearColor(66052,1);let Se=new Bn;Se.background=new Z(66052);let Ce=new Fa(37,1,.1,80);Ce.position.set(0,.2,13.6);let we=new Mn;we.position.set(0,-.35,0),Se.add(we);let Te=new Ii(c);Te.colorSpace=Ke,Te.minFilter=y,Te.magFilter=y,Te.generateMipmaps=!1;let Ee=new Wi(1,1,1,1),De=new ra({map:Te,color:12962516,roughness:.96,metalness:0,transparent:!0,alphaTest:.005,side:0}),Oe=new Si(Ee,De);we.add(Oe);let ke=new ra({color:526864,roughness:.9,metalness:.03}),Ae=new Si(new Wi(1.018,1.028),ke);Ae.position.z=-.035,we.add(Ae);let R=new Ca(7438491,1380632,.58);Se.add(R);let je=new Ha(9545416,.24);je.position.set(-4.8,5.6,7.4),Se.add(je);let z=new Mn;Se.add(z);let Me=new Si(new Hi(.24,.3,.11,24),new ra({color:1053208,roughness:.64,metalness:.7}));Me.position.copy(ie).add(new J(0,.08,0)),Se.add(Me);let B=new Si(new Hi(.014,.014,1,10),new ra({color:1184536,roughness:.5,metalness:.55}));Se.add(B);let Ne=new Mn;z.add(Ne);let V=[new q(.08,.08),new q(.18,.02),new q(.43,-.1),new q(.82,-.25),new q(1.08,-.36),new q(1.1,-.41)],H=new ra({color:1052950,roughness:.36,metalness:.74,side:2}),Pe=new Si(new Ui(V,48),H);Ne.add(Pe);let Fe=new Si(new Ki(1.095,.027,8,48),new ra({color:1513759,roughness:.28,metalness:.82}));Fe.rotation.x=Math.PI/2,Fe.position.y=-.397,Ne.add(Fe);let Ie=new ra({color:new Z(o.color).multiplyScalar(.18),emissive:o.color,emissiveIntensity:.42,roughness:.92,side:2}),Le=new Si(new Vi(1.055,48),Ie);Le.rotation.x=Math.PI/2,Le.position.y=-.385,Ne.add(Le);let Re=new Si(new Hi(.095,.12,.2,20),new ra({color:10250052,roughness:.44,metalness:.66}));Re.position.y=.08,Ne.add(Re);let ze=new ra({color:16766893,emissive:o.color,emissiveIntensity:3.2,roughness:.2}),Be=new Si(new Gi(.16,20,12),ze);Be.scale.y=1.2,Be.position.y=-.33,Ne.add(Be);let Ve=Je(),He=new Br({map:Ve,color:o.color,transparent:!0,opacity:.86,depthWrite:!1,blending:2}),Ue=new ei(He);Ue.position.y=-.36,Ue.scale.set(.96,.96,.96),Ne.add(Ue);let We=new La(o.color,1,18,Pt.degToRad(o.angle),.88,2);We.power=o.brightness,We.position.set(0,-.35,0),We.target.position.set(0,-7,0),Ne.add(We,We.target);let Ge=new za(o.color,1,3.2,2);Ge.power=36,Ge.position.set(0,-.35,0),Ne.add(Ge),s.current={spot:We,bulbLight:Ge,bulbMaterial:ze,glowMaterial:He,undersideMaterial:Ie};let qe=new Ml;qe.connect(xe,Ce),qe.add(Oe);function Je(){let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);if(t){let e=t.createRadialGradient(32,32,0,32,32,32);e.addColorStop(0,`rgba(255,255,255,1)`),e.addColorStop(.16,`rgba(255,222,172,.8)`),e.addColorStop(.46,`rgba(255,170,94,.22)`),e.addColorStop(1,`rgba(255,140,70,0)`),t.fillStyle=e,t.fillRect(0,0,64,64)}let n=new Fi(e);return n.colorSpace=Ke,n}function Ye(e=!0){let t=Math.max(1,i.clientWidth),n=Math.max(1,i.clientHeight),r=Math.min(window.devicePixelRatio||1,t<760?1.5:2);xe.setPixelRatio(r),xe.setSize(t,n,!1),Ce.aspect=t/n,Ce.updateProjectionMatrix();let a=c.offsetWidth||t,o=c.offsetHeight||n,s=n>t*1.16,l=s?7.2:12.8,u=o/a*l;Oe.scale.set(l,u,1),Ae.scale.set(l,u,1);let d=s?Pt.clamp(t*.3,110,200):Pt.clamp(Math.min(t*.17,n*.34),140,280),f=l/t,p=u/n;ne=d*f/2.2,z.scale.setScalar(ne),Me.scale.setScalar(ne),N=Pt.clamp(n*(s?.13:.16),s?72:80,150)*p,we.position.y=0;let m=s?18:12;if(ie.set(0,u/2-m*p,s?1.1:1.18),Me.position.copy(ie),Me.position.y+=.08*ne,!T){let e=I.copy(P).sub(ie);e.lengthSq()<.001&&e.copy(rd),e.normalize().multiplyScalar(N),P.copy(ie).add(e),ae.copy(P)}let h=Pt.degToRad(Ce.fov*.5),g=u/(2*Math.tan(h));Ce.position.set(0,0,g),Ce.lookAt(0,0,0),Ce.updateMatrixWorld(),qe.update(),i.requestPaint?.(),e&&$e()}function Xe(){ue.copy(P).sub(ie).normalize(),pe.copy(ie).add(P).multiplyScalar(.5),B.position.copy(pe),B.scale.set(ne,N,ne),ge.setFromUnitVectors(id,ue),B.quaternion.copy(ge),T?(de.copy(oe).sub(P).normalize(),fe.lerp(de,.32).normalize()):(me.setFromUnitVectors(rd,ue),de.copy(ad).applyQuaternion(me).normalize(),fe.lerp(de,.14).normalize()),he.setFromUnitVectors(rd,fe),z.position.copy(P),z.quaternion.copy(he)}function Ze(){le.copy(P).sub(ae).multiplyScalar(T?.985:.9948),ae.copy(P),P.add(le).addScaledVector(re,M*M),T&&(L.copy(oe).sub(ie).normalize(),L.lerp(rd,1-O*.82).normalize(),ce.copy(L).multiplyScalar(N).add(ie).sub(P),I.copy(P).sub(ie).normalize(),ce.addScaledVector(I,-ce.dot(I)),P.addScaledVector(ce,52*M*M)),I.copy(P).sub(ie),I.lengthSq()<1e-8&&I.copy(rd),I.normalize().multiplyScalar(N),P.copy(ie).add(I),le.copy(P).sub(ae),T?w=0:le.lengthSq()<14e-9?w+=1:w=0}function Qe(e){if(f=0,l)return;let t=Math.min((e-x)/1e3,.05);for(x=e,C=Math.min(C+t,M*5);C>=M;)Ze(),C-=M;Xe(),qe.update(),xe.render(Se,Ce),d+=1,(T||w<80||d<4)&&(f=requestAnimationFrame(Qe))}function $e(){w=0,!f&&!l&&(x=performance.now(),f=requestAnimationFrame(Qe))}u.current=$e;function et(e){let t=i.getBoundingClientRect();_e.x=(e.clientX-t.left)/t.width*2-1,_e.y=-((e.clientY-t.top)/t.height)*2+1,be.setFromCamera(_e,Ce)}function tt(e){if(et(e),!be.ray.intersectPlane(ye,oe))return!1;ve.copy(P).project(Ce);let t=(_e.x-ve.x)*Ce.aspect,n=_e.y-ve.y,r=Math.sqrt(t*t+n*n);return O=Pt.smoothstep(r,.08,1.15),!0}function nt(e){if(e.button===2){k=e.pointerId,A=e.clientX,ee=e.clientY,te=h.current.angle,j=!1,c.classList.add(`is-adjusting-beam`);return}e.button!==0||k!==-1||tt(e)&&(T=!0,E=e.pointerId,D=performance.now(),se.copy(oe),F.set(0,0,0),i.classList.add(`is-pulling-light`),$e())}function rt(e){if(e.pointerId===k){let t=e.clientX-A,n=e.clientY-ee;if(!j&&Math.hypot(t,n)>=4&&(j=!0),j){let e=Pt.clamp(Math.round(te+t*.14),16,60);m(t=>t.angle===e?t:{...t,angle:e}),$e()}return}if(!T||e.pointerId!==E||!tt(e))return;let t=performance.now(),n=Math.max(.008,Math.min(.05,(t-D)/1e3));I.copy(oe).sub(se).multiplyScalar(1/n),F.lerp(I,.34),se.copy(oe),D=t,$e()}function it(e){if(e.pointerId===k){let t=!j&&e.type!==`pointercancel`;k=-1,j=!1,c.classList.remove(`is-adjusting-beam`),t&&m(e=>{let t=a[(a.findIndex(t=>t===e.color.toLowerCase())+1)%a.length];return{...e,color:t}}),$e();return}if(!T||e.pointerId!==E)return;le.copy(P).sub(ae).multiplyScalar(1/M),I.copy(P).sub(ie).normalize(),F.addScaledVector(I,-F.dot(I)).clampLength(0,6);let t=Pt.lerp(.055,.12,O);if(le.addScaledVector(F,t),L.copy(ie).addScaledVector(rd,N).sub(P),L.addScaledVector(I,-L.dot(I)),L.lengthSq()>1e-4){L.normalize();let e=Pt.lerp(.32,1.6,O);le.addScaledVector(L,e)}le.clampLength(0,4.25),ae.copy(P).addScaledVector(le,-.008333333333333333),T=!1,E=-1,O=0,i.classList.remove(`is-pulling-light`),$e()}function at(){T=!1,E=-1,O=0,P.copy(ie).addScaledVector(rd,N),ae.copy(P),F.set(0,0,0),fe.copy(ad),i.classList.remove(`is-pulling-light`),k=-1,j=!1,c.classList.remove(`is-adjusting-beam`),$e()}function U(){cancelAnimationFrame(p),p=requestAnimationFrame(()=>Ye())}function W(){$e()}function ot(e){e.preventDefault()}i.addEventListener(`pointerdown`,nt),i.addEventListener(`dblclick`,at),i.addEventListener(`contextmenu`,ot),window.addEventListener(`pointermove`,rt,{passive:!0}),window.addEventListener(`pointerup`,it),window.addEventListener(`pointercancel`,it),window.addEventListener(`resize`,U,{passive:!0}),i.addEventListener(`paint`,W);function st(){let e=i.requestPaint;return e?new Promise((t,n)=>{v=()=>{window.clearTimeout(_),v=null,t()},_=window.setTimeout(()=>{v&&=(i.removeEventListener(`paint`,v),null),n(Error(`Timed out while preparing the interactive HTML surface.`))},3e4),i.addEventListener(`paint`,v,{once:!0}),e.call(i)}):Promise.resolve()}function ct(e){return e instanceof DOMException&&e.name===`InvalidStateError`&&e.message.includes(`snapshot`)}async function lt(){if(!l){Ye(!1),Xe(),qe.update();try{xe.render(Se,Ce)}catch(e){if(!ct(e))throw e;if(await st(),l)return;Ye(!1),Xe(),qe.update(),xe.render(Se,Ce)}d+=1,b(!0),e?.(),$e()}}return document.fonts.ready.then(lt).catch(e=>{l||(console.error(`Interactive light initialization failed.`,e),S(`The interactive light could not be initialized in this browser.`),t?.())}),()=>{l=!0,cancelAnimationFrame(f),cancelAnimationFrame(p),window.clearTimeout(_),v&&i.removeEventListener(`paint`,v),i.removeEventListener(`pointerdown`,nt),i.removeEventListener(`dblclick`,at),i.removeEventListener(`contextmenu`,ot),window.removeEventListener(`pointermove`,rt),window.removeEventListener(`pointerup`,it),window.removeEventListener(`pointercancel`,it),window.removeEventListener(`resize`,U),i.removeEventListener(`paint`,W),qe.disconnect(),u.current=null,s.current=null,Te.dispose(),Ee.dispose(),De.dispose(),Ae.geometry.dispose(),ke.dispose(),Pe.geometry.dispose(),H.dispose(),Fe.geometry.dispose(),Fe.material.dispose(),Le.geometry.dispose(),Ie.dispose(),Re.geometry.dispose(),Re.material.dispose(),Be.geometry.dispose(),ze.dispose(),B.geometry.dispose(),B.material.dispose(),Me.geometry.dispose(),Me.material.dispose(),Ve.dispose(),He.dispose(),xe.dispose()}},[g,t,e]),(0,i.useEffect)(()=>{h.current=p;let e=s.current;if(!e)return;let t=c.current.set(p.color),r=p.enabled?p.brightness:0;e.spot.color.copy(t),e.spot.power=r,e.spot.angle=Pt.degToRad(p.angle),e.bulbLight.color.copy(t),e.bulbLight.power=p.enabled?Math.max(18,p.brightness*.026):0,e.bulbMaterial.emissive.copy(t),e.bulbMaterial.emissiveIntensity=p.enabled?2.4+p.brightness/850:.04,e.glowMaterial.color.copy(t),e.glowMaterial.opacity=p.enabled?.52+p.brightness/4200:0,e.undersideMaterial.color.copy(t).multiplyScalar(.18),e.undersideMaterial.emissive.copy(t),e.undersideMaterial.emissiveIntensity=p.enabled?.22+p.brightness/7250:.03,n.current?.requestPaint?.(),u.current?.()},[p]),(0,l.jsxs)(`main`,{className:`experience-shell${v?` is-ready`:``}`,"aria-label":`Interactive Moria light study`,"aria-busy":!v&&!x,children:[(0,l.jsx)(`canvas`,{ref:n,className:`webgl-canvas`,"aria-label":`Interactive Moria light study`,children:(0,l.jsx)(d,{sourceRef:r,lighting:p})}),(0,l.jsx)(f,{hidden:v||!!x}),(0,l.jsxs)(`div`,{className:`scene-status${v||x?` is-hidden`:``}`,"aria-live":`polite`,children:[(0,l.jsx)(`span`,{}),` PREPARING HTML SURFACE`]}),x?(0,l.jsx)(`div`,{className:`scene-error`,children:x}):null]})}export{r as a,o as i,d as n,c as r,nd as t};